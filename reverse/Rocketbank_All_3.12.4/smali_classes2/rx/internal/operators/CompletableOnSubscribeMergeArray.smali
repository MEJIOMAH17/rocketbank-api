...
.method public final call(Lrx/CompletableSubscriber;)V
    ...
    .line 41
    iget-object v13, v6, Lrx/internal/operators/CompletableOnSubscribeMergeArray;->sources:[Lrx/Completable;
    ...
    .line 49
    invoke-virtual {v12, v10, v11}, Ljava/util/concurrent/atomic/AtomicBoolean;->compareAndSet(ZZ)Z
    ...
    invoke-virtual {v11, v10}, Lrx/Completable;->unsafeSubscribe(Lrx/CompletableSubscriber;)V
    ...
    .line 86
    invoke-virtual {v12, v1, v0}, Ljava/util/concurrent/atomic/AtomicBoolean;->compareAndSet(ZZ)Z
