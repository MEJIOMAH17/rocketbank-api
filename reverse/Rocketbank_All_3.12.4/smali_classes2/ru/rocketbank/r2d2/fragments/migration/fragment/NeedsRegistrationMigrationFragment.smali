.class public Lru/rocketbank/r2d2/fragments/migration/fragment/NeedsRegistrationMigrationFragment;
.super Lru/rocketbank/r2d2/fragments/migration/fragment/PhotoMigrationFragment;
.source "NeedsRegistrationMigrationFragment.java"
...
.method protected sendPhoto(Lokhttp3/MultipartBody$Part;)Lrx/Observable;
    ...
    sget-object v0, Lru/rocketbank/core/model/migration/Migration$Status;->needs_selfie:Lru/rocketbank/core/model/migration/Migration$Status;

    invoke-virtual {p0}, Lru/rocketbank/r2d2/fragments/migration/fragment/NeedsRegistrationMigrationFragment;->getMigration()Lru/rocketbank/core/model/migration/Migration;
    ...
    invoke-virtual {p0, p1}, Lru/rocketbank/r2d2/fragments/migration/fragment/NeedsRegistrationMigrationFragment;->finishStep(Lru/rocketbank/core/model/migration/Migration;)V
    ...
    .line 21
    :cond_0
    invoke-virtual {p0}, Lru/rocketbank/r2d2/fragments/migration/fragment/NeedsRegistrationMigrationFragment;->getMigrationApi()Lru/rocketbank/core/network/api/MigrationApi;

    move-result-object v0

    invoke-interface {v0, p1}, Lru/rocketbank/core/network/api/MigrationApi;->uploadPassportRegistration(Lokhttp3/MultipartBody$Part;)Lrx/Observable;
