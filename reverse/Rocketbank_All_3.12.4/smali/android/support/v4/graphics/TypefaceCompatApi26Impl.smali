.class public final Landroid/support/v4/graphics/TypefaceCompatApi26Impl;
...
.method private static addFontFromAssetManager$2c7a4f12(Landroid/content/Context;Ljava/lang/Object;Ljava/lang/String;II)Z
    .locals 3
...
# virtual methods
.method public final createFromFontFamilyFilesResourceEntry(Landroid/content/Context;Landroid/support/v4/content/res/FontResourcesParserCompat$FontFamilyFilesResourceEntry;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    .locals 6
    ...
    .line 217
    invoke-virtual {v3}, Landroid/support/v4/content/res/FontResourcesParserCompat$FontFileResourceEntry;->getFileName()Ljava/lang/String;
    ...
    .line 217
    invoke-static {p1, p3, v4, v5, v3}, Landroid/support/v4/graphics/TypefaceCompatApi26Impl;->addFontFromAssetManager$2c7a4f12(Landroid/content/Context;Ljava/lang/Object;Ljava/lang/String;II)Z
    ...
    .line 1201
    :try_start_0
    sget-object p1, Landroid/support/v4/graphics/TypefaceCompatApi26Impl;->sAbortCreation:Ljava/lang/reflect/Method;
...
.method public final createFromFontInfo$7af7ae3(Landroid/content/Context;[Landroid/support/v4/provider/FontsContractCompat$FontInfo;I)Landroid/graphics/Typeface;
    .locals 11
    ...
    .line 2120
    :cond_0
    sget-object v1, Landroid/support/v4/graphics/TypefaceCompatApi26Impl;->sAddFontFromAssetManager:Ljava/lang/reflect/Method;
    ...
    .line 239
    invoke-virtual {p0, p2, p3}, Landroid/support/v4/graphics/TypefaceCompatApi26Impl;->findBestInfo([Landroid/support/v4/provider/FontsContractCompat$FontInfo;I)Landroid/support/v4/provider/FontsContractCompat$FontInfo;
    ...
    .line 247
    invoke-virtual {p2}, Landroid/support/v4/provider/FontsContractCompat$FontInfo;->getWeight()I
    ...
    .line 248
    invoke-virtual {p2}, Landroid/support/v4/provider/FontsContractCompat$FontInfo;->isItalic()Z
    ...
    .line 254
    :cond_8
    invoke-static {p1, p2}, Landroid/support/v4/provider/FontsContractCompat;->prepareFontData$75fcca9b(Landroid/content/Context;[Landroid/support/v4/provider/FontsContractCompat$FontInfo;)Ljava/util/Map;
    ...
    .line 259
    invoke-virtual {v7}, Landroid/support/v4/provider/FontsContractCompat$FontInfo;->getUri()Landroid/net/Uri;
    ...
    .line 264
    invoke-virtual {v7}, Landroid/support/v4/provider/FontsContractCompat$FontInfo;->getTtcIndex()I

    move-result v6

    invoke-virtual {v7}, Landroid/support/v4/provider/FontsContractCompat$FontInfo;->getWeight()I

    move-result v9

    invoke-virtual {v7}, Landroid/support/v4/provider/FontsContractCompat$FontInfo;->isItalic()Z

    move-result v7

    .line 263
    invoke-static {v1, v8, v6, v9, v7}, Landroid/support/v4/graphics/TypefaceCompatApi26Impl;->addFontFromBuffer(Ljava/lang/Object;Ljava/nio/ByteBuffer;III)Z
...
.method public final createFromResourcesFontFile(Landroid/content/Context;Landroid/content/res/Resources;ILjava/lang/String;I)Landroid/graphics/Typeface;
    ...
    .line 293
    invoke-static {p1, p2, p4, p3, p3}, Landroid/support/v4/graphics/TypefaceCompatApi26Impl;->addFontFromAssetManager$2c7a4f12(Landroid/content/Context;Ljava/lang/Object;Ljava/lang/String;II)Z
