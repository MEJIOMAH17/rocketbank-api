...
.method private static findMenuItemForSubmenu(Landroid/support/v7/view/menu/MenuBuilder;Landroid/support/v7/view/menu/MenuBuilder;)Landroid/view/MenuItem;
    .locals 4
...
.method private static findParentViewForSubmenu(Landroid/support/v7/view/menu/CascadingMenuPopup$CascadingMenuInfo;Landroid/support/v7/view/menu/MenuBuilder;)Landroid/view/View;
    .locals 7

    .line 533
    iget-object v0, p0, Landroid/support/v7/view/menu/CascadingMenuPopup$CascadingMenuInfo;->menu:Landroid/support/v7/view/menu/MenuBuilder;

    invoke-static {v0, p1}, Landroid/support/v7/view/menu/CascadingMenuPopup;->findMenuItemForSubmenu(Landroid/support/v7/view/menu/MenuBuilder;Landroid/support/v7/view/menu/MenuBuilder;)Landroid/view/MenuItem;
...
.method private showMenu(Landroid/support/v7/view/menu/MenuBuilder;)V
    ...
    .line 391
    invoke-static {v1, p1}, Landroid/support/v7/view/menu/CascadingMenuPopup;->findParentViewForSubmenu(Landroid/support/v7/view/menu/CascadingMenuPopup$CascadingMenuInfo;Landroid/support/v7/view/menu/MenuBuilder;)Landroid/view/View;
...
.method public final onCloseMenu(Landroid/support/v7/view/menu/MenuBuilder;Z)V
    ...
    invoke-virtual {v2, v1}, Landroid/support/v7/widget/MenuPopupWindow;->setAnimationStyle(I)V
...
.method public final onSubMenuSelected(Landroid/support/v7/view/menu/SubMenuBuilder;)Z
    ...
    .line 4803
    iget-object p1, v1, Landroid/support/v7/view/menu/CascadingMenuPopup$CascadingMenuInfo;->window:Landroid/support/v7/widget/MenuPopupWindow;

    invoke-virtual {p1}, Landroid/support/v7/widget/MenuPopupWindow;->getListView()Landroid/widget/ListView;
