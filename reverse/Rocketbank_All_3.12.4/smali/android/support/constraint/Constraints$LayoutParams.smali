.class public final Landroid/support/constraint/Constraints$LayoutParams;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 95
    sget v3, Landroid/support/constraint/R$styleable;->ConstraintSet_android_alpha:I

    if-ne v0, v3, :cond_0

    .line 96
    iget v3, p0, Landroid/support/constraint/Constraints$LayoutParams;->alpha:F
    ...
    .line 97
    :cond_0
    sget v3, Landroid/support/constraint/R$styleable;->ConstraintSet_android_elevation:I

    if-ne v0, v3, :cond_1

    .line 98
    iget v3, p0, Landroid/support/constraint/Constraints$LayoutParams;->elevation:F
    ...
    .line 100
    :cond_1
    sget v3, Landroid/support/constraint/R$styleable;->ConstraintSet_android_rotationX:I

    if-ne v0, v3, :cond_2

    .line 101
    iget v3, p0, Landroid/support/constraint/Constraints$LayoutParams;->rotationX:F
    ...
    .line 102
    :cond_2
    sget v3, Landroid/support/constraint/R$styleable;->ConstraintSet_android_rotationY:I

    if-ne v0, v3, :cond_3

    .line 103
    iget v3, p0, Landroid/support/constraint/Constraints$LayoutParams;->rotationY:F
    ...
    .line 104
    :cond_3
    sget v3, Landroid/support/constraint/R$styleable;->ConstraintSet_android_rotation:I

    if-ne v0, v3, :cond_4

    .line 105
    iget v3, p0, Landroid/support/constraint/Constraints$LayoutParams;->rotation:F
    ...
    .line 106
    :cond_4
    sget v3, Landroid/support/constraint/R$styleable;->ConstraintSet_android_scaleX:I

    if-ne v0, v3, :cond_5

    .line 107
    iget v3, p0, Landroid/support/constraint/Constraints$LayoutParams;->scaleX:F
    ...
    .line 108
    :cond_5
    sget v3, Landroid/support/constraint/R$styleable;->ConstraintSet_android_scaleY:I

    if-ne v0, v3, :cond_6

    .line 109
    iget v3, p0, Landroid/support/constraint/Constraints$LayoutParams;->scaleY:F
    ...
    .line 110
    :cond_6
    sget v3, Landroid/support/constraint/R$styleable;->ConstraintSet_android_transformPivotX:I

    if-ne v0, v3, :cond_7

    .line 111
    iget v3, p0, Landroid/support/constraint/Constraints$LayoutParams;->transformPivotX:F
    ...
    .line 112
    :cond_7
    sget v3, Landroid/support/constraint/R$styleable;->ConstraintSet_android_transformPivotY:I

    if-ne v0, v3, :cond_8

    .line 113
    iget v3, p0, Landroid/support/constraint/Constraints$LayoutParams;->transformPivotY:F
    ...
    .line 114
    :cond_8
    sget v3, Landroid/support/constraint/R$styleable;->ConstraintSet_android_translationX:I

    if-ne v0, v3, :cond_9

    .line 115
    iget v3, p0, Landroid/support/constraint/Constraints$LayoutParams;->translationX:F
    ...
    .line 116
    :cond_9
    sget v3, Landroid/support/constraint/R$styleable;->ConstraintSet_android_translationY:I

    if-ne v0, v3, :cond_a

    .line 117
    iget v3, p0, Landroid/support/constraint/Constraints$LayoutParams;->translationY:F
    ...
    .line 118
    :cond_a
    sget v3, Landroid/support/constraint/R$styleable;->ConstraintSet_android_translationZ:I
