...
# direct methods
.method constructor <init>(Landroid/arch/lifecycle/LiveData;Landroid/arch/lifecycle/LifecycleOwner;Lkotlin/reflect/KParameter;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 353
    invoke-direct {p0, p1, p3}, Landroid/arch/lifecycle/LiveData$ObserverWrapper;-><init>(Landroid/arch/lifecycle/LiveData;Lkotlin/reflect/KParameter;)V
...
.method final isAttachedTo(Landroid/arch/lifecycle/LifecycleOwner;)Z
    .locals 1
...
.method public final onStateChanged(Landroid/arch/lifecycle/LifecycleOwner;Landroid/arch/lifecycle/Lifecycle$Event;)V
    ...
    iget-object p2, p0, Landroid/arch/lifecycle/LiveData$LifecycleBoundObserver;->mObserver$3232bbad:Lkotlin/reflect/KParameter;

    invoke-virtual {p1, p2}, Landroid/arch/lifecycle/LiveData;->removeObserver$4691b048(Lkotlin/reflect/KParameter;)V
    ...
    sget-object p2, Landroid/arch/lifecycle/Lifecycle$State;->STARTED:Landroid/arch/lifecycle/Lifecycle$State;

    invoke-virtual {p1, p2}, Landroid/arch/lifecycle/Lifecycle$State;->isAtLeast(Landroid/arch/lifecycle/Lifecycle$State;)Z
