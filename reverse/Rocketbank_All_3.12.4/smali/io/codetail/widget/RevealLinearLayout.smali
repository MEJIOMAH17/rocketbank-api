...
.method public final attachRevealInfo(Lio/codetail/animation/RevealAnimator$RevealInfo;)V
    ...
    .line 79
    iput-object p1, p0, Lio/codetail/widget/RevealLinearLayout;->mRevealInfo:Lio/codetail/animation/RevealAnimator$RevealInfo;
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    .line 97
    iget-boolean v0, p0, Lio/codetail/widget/RevealLinearLayout;->mRunning:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Lio/codetail/widget/RevealLinearLayout;->mRevealInfo:Lio/codetail/animation/RevealAnimator$RevealInfo;
    ...
    .line 101
    iget-object v2, p0, Lio/codetail/widget/RevealLinearLayout;->mRevealInfo:Lio/codetail/animation/RevealAnimator$RevealInfo;

    iget v2, v2, Lio/codetail/animation/RevealAnimator$RevealInfo;->centerX:I

    int-to-float v2, v2

    iget-object v3, p0, Lio/codetail/widget/RevealLinearLayout;->mRevealInfo:Lio/codetail/animation/RevealAnimator$RevealInfo;

    iget v3, v3, Lio/codetail/animation/RevealAnimator$RevealInfo;->centerY:I

    int-to-float v3, v3

    iget v4, p0, Lio/codetail/widget/RevealLinearLayout;->mRadius:F
...
.method public final getRevealRadius()F
    ...
    .line 71
    iget v0, p0, Lio/codetail/widget/RevealLinearLayout;->mRadius:F
...
.method public final onRevealAnimationCancel()V
    ...
    .line 1043
    iput-boolean v0, p0, Lio/codetail/widget/RevealLinearLayout;->mRunning:Z

    .line 1044
    iget-object v0, p0, Lio/codetail/widget/RevealLinearLayout;->mTargetBounds:Landroid/graphics/Rect;
...
.method public final setRevealRadius(F)V
    ...
    .line 59
    iput p1, p0, Lio/codetail/widget/RevealLinearLayout;->mRadius:F

    .line 60
    iget-object p1, p0, Lio/codetail/widget/RevealLinearLayout;->mRevealInfo:Lio/codetail/animation/RevealAnimator$RevealInfo;
    ...
    .line 61
    iget-object p1, p0, Lio/codetail/widget/RevealLinearLayout;->mTargetBounds:Landroid/graphics/Rect;

    invoke-virtual {p0, p1}, Lio/codetail/widget/RevealLinearLayout;->invalidate(Landroid/graphics/Rect;)V
...
.method public final startReverseAnimation()Lio/codetail/animation/SupportAnimator;
    ...
    .line 88
    iget-object v1, p0, Lio/codetail/widget/RevealLinearLayout;->mRevealInfo:Lio/codetail/animation/RevealAnimator$RevealInfo;
    ...
    iget-object v4, p0, Lio/codetail/widget/RevealLinearLayout;->mRevealInfo:Lio/codetail/animation/RevealAnimator$RevealInfo;
