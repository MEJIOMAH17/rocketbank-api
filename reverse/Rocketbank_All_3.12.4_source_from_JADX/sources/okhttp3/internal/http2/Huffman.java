...
final class Huffman {
    ...
    static void encode(ByteString byteString, BufferedSink bufferedSink) throws IOException {
        int i = 0;
        long j = 0;
        int i2 = 0;
    ...
    static int encodedLength(ByteString byteString) {
        long j = 0;
        int i = 0;
        while (i < byteString.size()) {
