...
public class MenuItemWrapperICS extends BaseMenuWrapper<SupportMenuItem> implements MenuItem {
    ...
    class OnActionExpandListenerWrapper extends MenuWrapperFactory<OnActionExpandListener> implements OnActionExpandListener {
    ...
    class OnMenuItemClickListenerWrapper extends MenuWrapperFactory<OnMenuItemClickListener> implements OnMenuItemClickListener {
    ...
    public final void setExclusiveCheckable$1385ff() {
        try {
            ...
            this.mSetExclusiveCheckableMethod.invoke(this.mWrappedObject, new Object[]{Boolean.TRUE});
        } catch (Throwable e) {
