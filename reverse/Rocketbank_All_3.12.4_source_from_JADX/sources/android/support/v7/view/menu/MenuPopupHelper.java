...
public class MenuPopupHelper {
    ...
    class C02261 implements OnDismissListener {
        C02261() {
        }
    ...
    public MenuPopupHelper(Context context, MenuBuilder menuBuilder) {
        this(context, menuBuilder, null, false, C0859R.attr.popupMenuStyle, 0);
    }

    public MenuPopupHelper(Context context, MenuBuilder menuBuilder, View view) {
        this(context, menuBuilder, view, false, C0859R.attr.popupMenuStyle, 0);
    }
    ...
    public MenuPopupHelper(Context context, MenuBuilder menuBuilder, View view, boolean z, int i, int i2) {
        ...
        this.mInternalOnDismissListener = new C02261();
    ...
    private MenuPopup createPopup() {
        ...
        if ((Math.min(point.x, point.y) >= this.mContext.getResources().getDimensionPixelSize(C0859R.dimen.abc_cascading_menus_min_smallest_width) ? 1 : null) != null) {
