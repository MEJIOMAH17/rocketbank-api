...
public class MenuBuilder implements SupportMenu {
    ...
    private static int getOrdering(int i) {
        ...
        if (i2 >= 0) {
            if (i2 < sCategoryToOrder.length) {
                return (i & ChatFragment.TYPE_MESSAGE_TYPING) | (sCategoryToOrder[i2] << 16);
            }
        }
    ...
    private void setShortcutsVisibleInner(boolean z) {
        boolean z2 = true;
        if (!z || this.mResources.getConfiguration().keyboard || !this.mResources.getBoolean(C0859R.bool.abc_config_showMenuShortcutsWhenKeyboardPresent)) {
            z2 = false;
        }
