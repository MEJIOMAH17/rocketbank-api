...
final class StandardMenuPopup extends MenuPopup implements MenuPresenter, OnKeyListener, OnItemClickListener, OnDismissListener {
    ...
    private final OnAttachStateChangeListener mAttachStateChangeListener = new C02282();
    private int mContentWidth;
    private final Context mContext;
    private int mDropDownGravity = 0;
    private final OnGlobalLayoutListener mGlobalLayoutListener = new C02271();
    ...
    class C02271 implements OnGlobalLayoutListener {
        C02271() {
        }
    ...
    class C02282 implements OnAttachStateChangeListener {
    ...
    public StandardMenuPopup(Context context, MenuBuilder menuBuilder, View view, int i, int i2, boolean z) {
        ...
        this.mPopupMaxWidth = Math.max(i.getDisplayMetrics().widthPixels / 2, i.getDimensionPixelSize(true));
            ...
            if (!this.mWasDismissed) {
                if (this.mAnchorView != null) {
                    ...
                    if (this.mShowTitle && this.mMenu.getHeaderTitle() != null) {
                        FrameLayout frameLayout = (FrameLayout) LayoutInflater.from(this.mContext).inflate(C0859R.layout.abc_popup_menu_header_item_layout, listView, false);
