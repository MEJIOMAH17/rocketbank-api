...
abstract class MenuPopup implements MenuPresenter, ShowableListMenu, OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
        ...
        if ((listAdapter instanceof HeaderViewListAdapter) != null) {
            view = (MenuAdapter) ((HeaderViewListAdapter) listAdapter).getWrappedAdapter();
        } else {
            view = (MenuAdapter) listAdapter;
        }
        view.mAdapterMenu.performItemAction((MenuItem) listAdapter.getItem(i), this, closeMenuOnSubMenuOpened() != 0 ? 0 : 4);
    }
