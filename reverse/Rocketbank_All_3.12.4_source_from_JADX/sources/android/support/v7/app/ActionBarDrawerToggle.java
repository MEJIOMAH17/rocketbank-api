...
public class ActionBarDrawerToggle implements DrawerListener {
    ...
    static class IcsDelegate implements Delegate {
        ...
        public final void setActionBarUpIndicator(Drawable drawable, int i) {
            ...
            if (actionBar != null) {
                ...
                this.mSetIndicatorInfo = ActionBarDrawerToggleHoneycomb.setActionBarUpIndicator$3bf15dea(this.mActivity, drawable, i);
    ...
    static class JellybeanMr2Delegate implements Delegate {
        ...
        public final Drawable getThemeUpIndicator() {
            ...
            TypedArray obtainStyledAttributes = themedContext.obtainStyledAttributes(null, new int[]{16843531}, 16843470, 0);
    ...
    void toggle() {
        ...
        if (!this.mDrawerLayout.isDrawerVisible$134632() || drawerLockMode == 2) {
            if (drawerLockMode != 1) {
    ...
    public void onDrawerSlide(View view, float f) {
        if (this.mDrawerSlideAnimationEnabled != null) {
            setPosition(Math.min(1.0f, Math.max(BitmapDescriptorFactory.HUE_RED, f)));
        } else {
            setPosition(BitmapDescriptorFactory.HUE_RED);
        }
    }
