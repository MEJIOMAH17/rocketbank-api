...
class ActionMenuPresenter extends BaseMenuPresenter implements SubUiVisibilityListener {
    ...
    private static class SavedState implements Parcelable {
        ...
        static class C02341 implements Creator<SavedState> {
            C02341() {
            }
    ...
    private class ActionButtonSubmenu extends MenuPopupHelper {
        public ActionButtonSubmenu(Context context, SubMenuBuilder subMenuBuilder, View view) {
            super(context, subMenuBuilder, view, false, C0859R.attr.actionOverflowMenuStyle);
    ...
    private class OverflowPopup extends MenuPopupHelper {
        public OverflowPopup(Context context, MenuBuilder menuBuilder, View view, boolean z) {
            super(context, menuBuilder, view, z, C0859R.attr.actionOverflowMenuStyle);
    ...
    private class OverflowMenuButton extends AppCompatImageView implements ActionMenuChildView {
        ...
        public OverflowMenuButton(Context context) {
            super(context, null, C0859R.attr.actionOverflowButtonStyle);
            setClickable(true);
            setFocusable(true);
            setVisibility(0);
            setEnabled(true);
        ...
        protected boolean setFrame(int i, int i2, int i3, int i4) {
            ...
            if (!(i2 == 0 || i3 == 0)) {
                ...
                if (VERSION.SDK_INT >= 21) {
                    i3.setHotspotBounds(i5, i6, i2, i4);
                }
            }
            return i;
        }
    ...
    public ActionMenuPresenter(Context context) {
        super(context, C0859R.layout.abc_action_menu_layout, C0859R.layout.abc_action_menu_item_layout);
    }
