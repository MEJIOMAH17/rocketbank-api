...
public class ActionBarOverlayLayout extends ViewGroup implements NestedScrollingParent, DecorContentParent {
    static final int[] ATTRS = new int[]{C0859R.attr.actionBarSize, 16842841};
    ...
    class C02311 extends AnimatorListenerAdapter {
        C02311() {
        }
    ...
    class C02322 implements Runnable {
        ...
        public void run() {
            ...
            ActionBarOverlayLayout.this.mCurrentActionBarTopAnimator = ActionBarOverlayLayout.this.mActionBarTop.animate().translationY(BitmapDescriptorFactory.HUE_RED).setListener(ActionBarOverlayLayout.this.mTopAnimatorListener);
        }
    }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mTopAnimatorListener = new C02311();
        this.mRemoveActionBarHideOffset = new C02322();
        this.mAddActionBarHideOffset = new C02333();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0859R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0859R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0859R.id.action_bar));
        }
    }
