...
public class RecyclerView extends ViewGroup implements NestedScrollingChild2, ScrollingView {
    ...
    static final Interpolator sQuinticInterpolator = new C02613();
    ...
    static class C02613 implements Interpolator {
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        public final void bindViewHolder(VH vh, int i) {
            ...
            vh.setFlags(1, 519);
            String str = RecyclerView.TRACE_BIND_VIEW_TAG;
        ...
        public final VH createViewHolder(ViewGroup viewGroup, int i) {
            try {
                String str = RecyclerView.TRACE_CREATE_VIEW_TAG;
                if (VERSION.SDK_INT >= 18) {
                    Trace.beginSection(str);
                }
    ...
    public static abstract class LayoutManager {
        ...
        private final Callback mHorizontalBoundCheckCallback = new C09721();
        ...
        private final Callback mVerticalBoundCheckCallback = new C09732();
        private int mWidth;
        ...
        class C09721 implements Callback {
            C09721() {
            }
        ...
        class C09732 implements Callback {
            C09732() {
            }
        ...
        public static Properties getProperties(Context context, AttributeSet attributeSet, int i, int i2) {
            ...
            context = context.obtainStyledAttributes(attributeSet, C0945R.styleable.RecyclerView, i, i2);
            properties.orientation = context.getInt(C0945R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = context.getInt(C0945R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = context.getBoolean(C0945R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = context.getBoolean(C0945R.styleable.RecyclerView_stackFromEnd, false);
            context.recycle();
            return properties;
        }
        ...
        public void run() {
            ...
            if (overScroller.computeScrollOffset()) {
                ...
                if (RecyclerView.this.mAdapter != null) {
                    ...
                    String str = RecyclerView.TRACE_SCROLL_TAG;
                    if (VERSION.SDK_INT >= 18) {
                        Trace.beginSection(str);
                    }
    ...
    class C09694 implements ProcessCallback {
        C09694() {
        }
    ...
    class C09705 implements Callback {
        C09705() {
        }
    ...
    class C09716 implements Callback {
        C09716() {
        }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = new C02621();
        Parcelable mLayoutState;

        /* renamed from: android.support.v7.widget.RecyclerView$SavedState$1 */
        static class C02621 implements ClassLoaderCreator<SavedState> {
            C02621() {
            }
    ...
    public RecyclerView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mViewInfoProcessCallback = new C09694();
        ...
        if (attributeSet != null) {
            obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0945R.styleable.RecyclerView, i, 0);
            String string = obtainStyledAttributes.getString(C0945R.styleable.RecyclerView_layoutManager);
            if (obtainStyledAttributes.getInt(C0945R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(262144);
            }
            this.mEnableFastScroller = obtainStyledAttributes.getBoolean(C0945R.styleable.RecyclerView_fastScrollEnabled, false);
            if (this.mEnableFastScroller) {
                initFastScroller((StateListDrawable) obtainStyledAttributes.getDrawable(C0945R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), obtainStyledAttributes.getDrawable(C0945R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) obtainStyledAttributes.getDrawable(C0945R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), obtainStyledAttributes.getDrawable(C0945R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
            obtainStyledAttributes.recycle();
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C09705());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C09716());
    }
        ...
        if (this.mFirstLayoutComplete) {
            if (!this.mDataSetHasChangedAfterLayout) {
                ...
                if (!this.mAdapterHelper.hasAnyUpdateTypes(4) || this.mAdapterHelper.hasAnyUpdateTypes(11)) {
                    if (this.mAdapterHelper.hasPendingUpdates()) {
                        str = TRACE_ON_DATA_SET_CHANGE_LAYOUT_TAG;
                        if (VERSION.SDK_INT >= 18) {
                            Trace.beginSection(str);
                        }
                        dispatchLayout();
                ...
                str = TRACE_HANDLE_ADAPTER_UPDATES_TAG;
                if (VERSION.SDK_INT >= 18) {
                    Trace.beginSection(str);
                }
                startInterceptRequestLayout();
    ...
    boolean scrollByInternal(int i, int i2, MotionEvent motionEvent) {
        ...
        if (this.mAdapter != null) {
            ...
            startInterceptRequestLayout();
            onEnterLayoutOrScroll();
            String str = TRACE_SCROLL_TAG;
            if (VERSION.SDK_INT >= 18) {
                Trace.beginSection(str);
            }
            fillRemainingScrollValues(r7.mState);
            if (i7 != 0) {
                scrollHorizontallyBy = r7.mLayout.scrollHorizontallyBy(i7, r7.mRecycler, r7.mState);
                i9 = i7 - scrollHorizontallyBy;
            } else {
                scrollHorizontallyBy = 0;
                i9 = scrollHorizontallyBy;
            }
            if (i8 != 0) {
                scrollVerticallyBy = r7.mLayout.scrollVerticallyBy(i8, r7.mRecycler, r7.mState);
                i10 = i8 - scrollVerticallyBy;
            } else {
                scrollVerticallyBy = 0;
        ...
        if (dispatchNestedScroll(i3, i5, i4, i6, r7.mScrollOffset, 0)) {
            ...
            if (!(motionEvent2 == null || MotionEventCompat.isFromSource(motionEvent2, 8194))) {
                pullGlows(motionEvent.getX(), (float) i4, motionEvent.getY(), (float) i6);
            }
    ...
    private void pullGlows(float f, float f2, float f3, float f4) {
        ...
        if (f2 < BitmapDescriptorFactory.HUE_RED) {
            ...
            if (obj == null || f2 != BitmapDescriptorFactory.HUE_RED || f4 != BitmapDescriptorFactory.HUE_RED) {
                ...
                if (dispatchOnItemTouch(motionEvent)) {
                    ...
                    switch (actionMasked) {
                        ...
                        case 1:
                            ...
                            float f = canScrollHorizontally != 0 ? -this.mVelocityTracker.getXVelocity(this.mScrollPointerId) : BitmapDescriptorFactory.HUE_RED;
                            float f2 = canScrollVertically ? -this.mVelocityTracker.getYVelocity(this.mScrollPointerId) : BitmapDescriptorFactory.HUE_RED;
                            if ((f == BitmapDescriptorFactory.HUE_RED && f2 == BitmapDescriptorFactory.HUE_RED) || fling((int) f, (int) f2) == null) {
                                setScrollState(0);
                            }
                            resetTouch();
                            z = true;
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.mLeftGlow == null || this.mLeftGlow.isFinished()) {
            ...
            canvas.translate((float) ((-getHeight()) + i), BitmapDescriptorFactory.HUE_RED);
    ...
    void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        if (!(stateListDrawable == null || drawable == null || stateListDrawable2 == null)) {
            if (drawable2 != null) {
                ...
                FastScroller fastScroller = new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C0859R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0859R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0859R.dimen.fastscroll_margin));
                return;
            }
        }
