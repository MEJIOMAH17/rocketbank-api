...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    RoundRectDrawableWithShadow(Resources resources, ColorStateList colorStateList, float f, float f2, float f3) {
        this.mShadowStartColor = resources.getColor(C0859R.color.cardview_shadow_start_color);
        this.mShadowEndColor = resources.getColor(C0859R.color.cardview_shadow_end_color);
        this.mInsetShadow = resources.getDimensionPixelSize(C0859R.dimen.cardview_compat_inset_shadow);
    ...
    private void drawShadow(Canvas canvas) {
        ...
        float f3 = f2 * 2.0f;
        Object obj = this.mCardBounds.width() - f3 > BitmapDescriptorFactory.HUE_RED ? 1 : null;
        Object obj2 = this.mCardBounds.height() - f3 > BitmapDescriptorFactory.HUE_RED ? 1 : null;
        int save = canvas.save();
        canvas.translate(this.mCardBounds.left + f2, this.mCardBounds.top + f2);
        canvas.drawPath(this.mCornerShadowPath, this.mCornerShadowPaint);
        if (obj != null) {
            canvas.drawRect(BitmapDescriptorFactory.HUE_RED, f, this.mCardBounds.width() - f3, -this.mCornerRadius, this.mEdgeShadowPaint);
        }
        ...
        canvas.drawPath(this.mCornerShadowPath, this.mCornerShadowPaint);
        if (obj != null) {
            canvas.drawRect(BitmapDescriptorFactory.HUE_RED, f, this.mCardBounds.width() - f3, (-this.mCornerRadius) + this.mShadowSize, this.mEdgeShadowPaint);
        }
        canvas.restoreToCount(save);
        ...
        canvas.drawPath(this.mCornerShadowPath, this.mCornerShadowPaint);
        if (obj2 != null) {
            canvas.drawRect(BitmapDescriptorFactory.HUE_RED, f, this.mCardBounds.height() - f3, -this.mCornerRadius, this.mEdgeShadowPaint);
        }
    ...
    private void buildShadowCorners() {
        ...
        r0.mCornerShadowPaint.setShader(new RadialGradient(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, r0.mCornerRadius + r0.mShadowSize, new int[]{r0.mShadowStartColor, r0.mShadowStartColor, r0.mShadowEndColor}, new float[]{BitmapDescriptorFactory.HUE_RED, f, 1.0f}, TileMode.CLAMP));
        r0.mEdgeShadowPaint.setShader(new LinearGradient(BitmapDescriptorFactory.HUE_RED, (-r0.mCornerRadius) + r0.mShadowSize, BitmapDescriptorFactory.HUE_RED, (-r0.mCornerRadius) - r0.mShadowSize, new int[]{r0.mShadowStartColor, r0.mShadowStartColor, r0.mShadowEndColor}, new float[]{BitmapDescriptorFactory.HUE_RED, 0.5f, 1.0f}, TileMode.CLAMP));
