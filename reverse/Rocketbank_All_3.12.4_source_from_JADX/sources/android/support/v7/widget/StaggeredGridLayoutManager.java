...
public class StaggeredGridLayoutManager extends LayoutManager implements ScrollVectorProvider {
    ...
    private final Runnable mCheckForGapsRunnable = new C02751();
    ...
    static class LazySpanLookup {
        ...
        static class FullSpanItem implements Parcelable {
            public static final Creator<FullSpanItem> CREATOR = new C02761();
            int mGapDir;
            int[] mGapPerSpan;
            ...
            static class C02761 implements Creator<FullSpanItem> {
                C02761() {
                }
        ...
        void offsetForRemoval(int i, int i2) {
            if (this.mData != null) {
                if (i < this.mData.length) {
                    ...
                    System.arraycopy(obj, i3, obj2, i, (obj2.length - i) - i2);
        ...
        void offsetForAddition(int i, int i2) {
            if (this.mData != null) {
                if (i < this.mData.length) {
                    ...
                    ensureSize(i3);
                    Object obj = this.mData;
                    System.arraycopy(obj, i, obj, i3, (this.mData.length - i) - i2);
    ...
    public static class SavedState implements Parcelable {
        ...
        static class C02771 implements Creator<SavedState> {
            C02771() {
            }
        ...
        if (!(getChildCount() == 0 || this.mGapStrategy == 0)) {
            if (isAttachedToWindow()) {
                ...
                if (lastChildPosition == 0 && hasGapsToFix() != null) {
                    ...
                    FullSpanItem firstFullSpanItemInRange2 = this.mLazySpanLookup.getFirstFullSpanItemInRange(lastChildPosition, firstFullSpanItemInRange.mPosition, -i, true);
