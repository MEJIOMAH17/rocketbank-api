...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    private final OnItemTouchListener mOnItemTouchListener = new C09762();
    View mOverdrawChild = null;
    int mOverdrawChildPosition = -1;
    final List<View> mPendingCleanup = new ArrayList();
    List<RecoverAnimation> mRecoverAnimations = new ArrayList();
    RecyclerView mRecyclerView;
    final Runnable mScrollRunnable = new C02851();
    ...
    public static abstract class Callback {
        ...
        private static final Interpolator sDragScrollInterpolator = new C02871();
        private static final Interpolator sDragViewScrollCapInterpolator = new C02882();
        private static final ItemTouchUIUtil sUICallback;
        private int mCachedMaxScrollSpeed = -1;

        /* renamed from: android.support.v7.widget.helper.ItemTouchHelper$Callback$1 */
        static class C02871 implements Interpolator {
        ...
        private int getMaxDragScroll(RecyclerView recyclerView) {
            if (this.mCachedMaxScrollSpeed == -1) {
                this.mCachedMaxScrollSpeed = recyclerView.getResources().getDimensionPixelSize(C0859R.dimen.item_touch_helper_max_drag_scroll_per_frame);
            }
            ...
            if (this.mShouldReactToLongPress) {
                ...
                if (findChildView != null) {
                    ...
                    if (childViewHolder != null && ItemTouchHelper.this.mCallback.hasDragFlag(ItemTouchHelper.this.mRecyclerView, childViewHolder) && motionEvent.getPointerId(0) == ItemTouchHelper.this.mActivePointerId) {
                        ...
                        motionEvent.mDx = BitmapDescriptorFactory.HUE_RED;
    ...
    class C09762 implements OnItemTouchListener {
        C09762() {
        }
    ...
    class C09785 implements ChildDrawingOrderCallback {
        C09785() {
        }
    ...
    public void attachToRecyclerView(RecyclerView recyclerView) {
        if (this.mRecyclerView != recyclerView) {
            ...
            if (recyclerView != null) {
                ...
                this.mSwipeEscapeVelocity = recyclerView.getDimension(C0859R.dimen.item_touch_helper_swipe_escape_velocity);
                this.mMaxSwipeVelocity = recyclerView.getDimension(C0859R.dimen.item_touch_helper_swipe_escape_max_velocity);
                setupCallbacks();
            }
        }
    }
        ...
        if (viewHolder2 != this.mSelected || i2 != r11.mActionState) {
            ...
            if (r11.mSelected != null) {
                ...
                if (viewHolder3.itemView.getParent() != null) {
                    ...
                    RecoverAnimation c09773 = new RecoverAnimation(viewHolder3, i6, i3, f2, f3, f, signum) {
                        public void onAnimationEnd(Animator animator) {
            ...
            if (viewHolder2 != null) {
                r11.mSelectedFlags = (r11.mCallback.getAbsoluteMovementFlags(r11.mRecyclerView, viewHolder2) & i4) >> (r11.mActionState << 3);
    ...
    boolean scrollIfNecessary() {
        ...
        if (layoutManager.canScrollHorizontally()) {
            ...
            if (r0.mDx < BitmapDescriptorFactory.HUE_RED && paddingLeft < 0) {
                i2 = paddingLeft;
                if (layoutManager.canScrollVertically()) {
                    i3 = (int) (r0.mSelectedStartY + r0.mDy);
                    i = (i3 - r0.mTmpRect.top) - r0.mRecyclerView.getPaddingTop();
                    if (r0.mDy >= BitmapDescriptorFactory.HUE_RED) {
                    }
                    if (r0.mDy > BitmapDescriptorFactory.HUE_RED) {
                ...
                r0.mRecyclerView.scrollBy(i, i3);
                return true;
            } else if (r0.mDx > BitmapDescriptorFactory.HUE_RED) {
                ...
                if (i > 0) {
                    ...
                    if (layoutManager.canScrollVertically()) {
                        i3 = (int) (r0.mSelectedStartY + r0.mDy);
                        i = (i3 - r0.mTmpRect.top) - r0.mRecyclerView.getPaddingTop();
                        if (r0.mDy >= BitmapDescriptorFactory.HUE_RED && i < 0) {
                            i3 = i;
                            if (i2 != 0) {
                                i2 = r0.mCallback.interpolateOutOfBoundsScroll(r0.mRecyclerView, r0.mSelected.itemView.getWidth(), i2, r0.mRecyclerView.getWidth(), j);
                            }
                            ...
                            r0.mRecyclerView.scrollBy(i, i3);
                            return true;
                        } else if (r0.mDy > BitmapDescriptorFactory.HUE_RED) {
                            i3 = ((i3 + r0.mSelected.itemView.getHeight()) + r0.mTmpRect.bottom) - (r0.mRecyclerView.getHeight() - r0.mRecyclerView.getPaddingBottom());
                            if (i3 > 0) {
                                if (i2 != 0) {
                                    i2 = r0.mCallback.interpolateOutOfBoundsScroll(r0.mRecyclerView, r0.mSelected.itemView.getWidth(), i2, r0.mRecyclerView.getWidth(), j);
    ...
    boolean checkSelectForSwipe(int i, MotionEvent motionEvent, int i2) {
        if (this.mSelected == null && i == 2 && this.mActionState != 2) {
            if (this.mCallback.isItemViewSwipeEnabled() != 0) {
                ...
                int absoluteMovementFlags = (this.mCallback.getAbsoluteMovementFlags(this.mRecyclerView, i) >> 8) & 255;
    ...
    private void addChildDrawingOrderCallback() {
        if (VERSION.SDK_INT < 21) {
            if (this.mChildDrawingOrderCallback == null) {
                this.mChildDrawingOrderCallback = new C09785();
            }
