...
class FastScroller extends ItemDecoration implements OnItemTouchListener {
    ...
    private final Runnable mHideRunnable = new C02511();
    ...
    private final OnScrollListener mOnScrollListener = new C09552();
    private RecyclerView mRecyclerView;
    private int mRecyclerViewHeight = 0;
    private int mRecyclerViewWidth = 0;
    private final int mScrollbarMinimumRange;
    private final ValueAnimator mShowHideAnimator = ValueAnimator.ofFloat(new float[]{BitmapDescriptorFactory.HUE_RED, 1.0f});
    ...
    private class AnimatorListener extends AnimatorListenerAdapter {
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            } else if (((Float) FastScroller.this.mShowHideAnimator.getAnimatedValue()).floatValue() == BitmapDescriptorFactory.HUE_RED) {
    ...
    class C09552 extends OnScrollListener {
        C09552() {
        }
    ...
    void hide(int i) {
        ...
        this.mShowHideAnimator.setFloatValues(new float[]{((Float) this.mShowHideAnimator.getAnimatedValue()).floatValue(), BitmapDescriptorFactory.HUE_RED});
    ...
    public void onTouchEvent(RecyclerView recyclerView, MotionEvent motionEvent) {
        if (this.mState != null) {
            if (motionEvent.getAction() == null) {
                ...
                this.mVerticalDragY = BitmapDescriptorFactory.HUE_RED;
                this.mHorizontalDragX = BitmapDescriptorFactory.HUE_RED;
                setState(1);
