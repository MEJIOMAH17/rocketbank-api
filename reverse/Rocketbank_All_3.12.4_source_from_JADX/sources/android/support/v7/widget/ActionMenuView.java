...
public class ActionMenuView extends LinearLayoutCompat implements ItemInvoker, MenuView {
    ...
    private void onMeasureExactFormat(int i, int i2) {
        ...
        while (paddingLeft < i3) {
            ...
            if (childAt2.getVisibility() != 8) {
                ...
                z3 = z4 && (TextUtils.isEmpty(((ActionMenuItemView) childAt2).getText()) ^ 1) != 0;
        ...
        if (i12 == 0) {
            ...
            if (i13 == 1) {
                ...
                if (i10 > 0 || j == 0 || (i10 >= i13 - r2 && size2 == 0 && i14 <= r2)) {
                    ...
                    i18 = bitCount > BitmapDescriptorFactory.HUE_RED ? (int) (((float) (i10 * i9)) / bitCount) : size2;
                    z2 = z;
                    size = i7;
    ...
    static int measureChildForCells(View view, int i, int i2, int i3, int i4) {
        ...
        boolean z = false;
        i4 = (i4 == 0 || (TextUtils.isEmpty(i4.getText()) ^ 1) == 0) ? 0 : 1;
        int i5 = 2;
        if (i2 <= 0 || (i4 != 0 && i2 < 2)) {
            i5 = 0;
        } else {
