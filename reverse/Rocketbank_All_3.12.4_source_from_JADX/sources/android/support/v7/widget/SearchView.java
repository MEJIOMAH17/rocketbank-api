...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C02663 implements OnFocusChangeListener {
        C02663() {
        }
    ...
    class C02674 implements OnLayoutChangeListener {
        C02674() {
        }
    ...
    class C02696 implements OnKeyListener {
        C02696() {
        }
    ...
    class C02707 implements OnEditorActionListener {
        C02707() {
        }
    ...
    class C02718 implements OnItemClickListener {
        C02718() {
        }
    ...
    class C02729 implements OnItemSelectedListener {
...
*/
    ...
    static class SavedState extends AbsSavedState {
        ...
        static class C02731 implements ClassLoaderCreator<SavedState> {
            C02731() {
            }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attributeSet) {
            this(context, attributeSet, C0859R.attr.autoCompleteTextViewStyle);
        }

        public SearchAutoComplete(Context context, AttributeSet attributeSet, int i) {
            super(context, attributeSet, i);
            this.mRunShowSoftInputIfNecessary = new C02741();
    ...
    public SearchView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0859R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mUpdateDrawableStateRunnable = new C02641();
        this.mReleaseCursorRunnable = new C02652();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C02685();
        this.mTextKeyListener = new C02696();
        this.mOnEditorActionListener = new C02707();
        this.mOnItemClickListener = new C02718();
        this.mOnItemSelectedListener = new C02729();
        ...
        attributeSet = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0219R.styleable.SearchView, i, 0);
        LayoutInflater.from(context).inflate(attributeSet.getResourceId(C0219R.styleable.SearchView_layout, C0859R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0859R.id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0859R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0859R.id.search_plate);
        this.mSubmitArea = findViewById(C0859R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0859R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0859R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0859R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0859R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0859R.id.search_mag_icon);
        ViewCompat.setBackground(this.mSearchPlate, attributeSet.getDrawable(C0219R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, attributeSet.getDrawable(C0219R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(attributeSet.getDrawable(C0219R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(attributeSet.getDrawable(C0219R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(attributeSet.getDrawable(C0219R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(attributeSet.getDrawable(C0219R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(attributeSet.getDrawable(C0219R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = attributeSet.getDrawable(C0219R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(this.mSearchButton, getResources().getString(C0859R.string.abc_searchview_description_search));
        this.mSuggestionRowLayout = attributeSet.getResourceId(C0219R.styleable.SearchView_suggestionRowLayout, C0859R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = attributeSet.getResourceId(C0219R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C02663());
        setIconifiedByDefault(attributeSet.getBoolean(C0219R.styleable.SearchView_iconifiedByDefault, true));
        context = attributeSet.getDimensionPixelSize(C0219R.styleable.SearchView_android_maxWidth, -1);
        if (context != -1) {
            setMaxWidth(context);
        }
        this.mDefaultQueryHint = attributeSet.getText(C0219R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = attributeSet.getText(C0219R.styleable.SearchView_queryHint);
        context = attributeSet.getInt(C0219R.styleable.SearchView_android_imeOptions, -1);
        if (context != -1) {
            setImeOptions(context);
        }
        context = attributeSet.getInt(C0219R.styleable.SearchView_android_inputType, -1);
        if (context != -1) {
            setInputType(context);
        }
        setFocusable(attributeSet.getBoolean(C0219R.styleable.SearchView_android_focusable, true));
        ...
        if (this.mDropDownAnchor != null) {
            this.mDropDownAnchor.addOnLayoutChangeListener(new C02674());
        }
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0859R.dimen.abc_search_view_preferred_width);
    }

    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0859R.dimen.abc_search_view_preferred_height);
    }
...
*/
    ...
    void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int dimensionPixelSize = this.mIconifiedByDefault ? resources.getDimensionPixelSize(C0859R.dimen.abc_dropdownitem_icon_width) + resources.getDimensionPixelSize(C0859R.dimen.abc_dropdownitem_text_padding_left) : 0;
