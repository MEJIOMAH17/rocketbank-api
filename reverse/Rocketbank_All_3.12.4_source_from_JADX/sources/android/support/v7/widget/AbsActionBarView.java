...
abstract class AbsActionBarView extends ViewGroup {
    ...
    AbsActionBarView(Context context, AttributeSet attributeSet, int i) {
        ...
        if (context.getTheme().resolveAttribute(C0859R.attr.actionBarPopupTheme, attributeSet, true) == 0 || attributeSet.resourceId == 0) {
    ...
    protected void onConfigurationChanged(Configuration configuration) {
        ...
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(null, C0219R.styleable.ActionBar, C0859R.attr.actionBarStyle, 0);
        setContentHeight(obtainStyledAttributes.getLayoutDimension(C0219R.styleable.ActionBar_height, 0));
    ...
    public ViewPropertyAnimatorCompat setupAnimatorToVisibility(int i, long j) {
        ...
        alpha = ViewCompat.animate(this).alpha(BitmapDescriptorFactory.HUE_RED);
        alpha.setDuration(j);
        alpha.setListener(this.mVisAnimListener.withFinalVisibility(alpha, i));
        return alpha;
    }
