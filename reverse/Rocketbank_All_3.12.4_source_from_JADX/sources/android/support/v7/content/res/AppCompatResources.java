...
public final class AppCompatResources {
    ...
    public static ColorStateList getColorStateList(Context context, int i) {
        ...
        synchronized (sColorStateCacheLock) {
            ...
            sparseArray.append(i, new ColorStateListCacheEntry(cachedColorStateList, context.getResources().getConfiguration()));
        }
        return cachedColorStateList;
    }
    ...
    private static ColorStateList inflateColorStateList(Context context, int i) {
        ...
        try {
            return AppCompatColorStateListInflater.createFromXml(resources2, resources2.getXml(i), context.getTheme());
