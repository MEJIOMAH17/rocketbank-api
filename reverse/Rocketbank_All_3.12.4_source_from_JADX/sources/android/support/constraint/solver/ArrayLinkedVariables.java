...
public final class ArrayLinkedVariables {
    ...
    final void divideByAmount(float f) {
        int i = this.mHead;
        int i2 = 0;
        while (i != -1 && i2 < this.currentSize) {
            float[] fArr = this.mArrayValues;
    ...
    final SolverVariable chooseSubject$74f079fa() {
        int i = this.mHead;
        ...
        while (i != -1 && i2 < this.currentSize) {
            ...
            if (f3 < BitmapDescriptorFactory.HUE_RED) {
                if (f3 > -0.001f) {
                    this.mArrayValues[i] = BitmapDescriptorFactory.HUE_RED;
                ...
                if (f3 != BitmapDescriptorFactory.HUE_RED) {
                    if (solverVariable3.mType == Type.UNRESTRICTED) {
                        if (solverVariable == null) {
                            if (f > f3) {
                                if (solverVariable3.usageInRowCount <= 1) {
                                }
                            } else if (i3 == 0) {
                                if ((solverVariable3.usageInRowCount <= 1 ? 1 : null) != null) {
                                }
                            }
                            f = f3;
                            solverVariable = solverVariable3;
                            i3 = i5;
                        } else if (solverVariable3.usageInRowCount <= 1) {
                            f = f3;
                            solverVariable = solverVariable3;
                            i3 = i5;
                        }
                        ...
                        solverVariable = solverVariable3;
                        i3 = i5;
                    } else if (solverVariable == null && f3 < BitmapDescriptorFactory.HUE_RED) {
    ...
    final void updateFromRow$1b2a3577(ArrayRow arrayRow, ArrayRow arrayRow2) {
        int i = this.mHead;
        while (true) {
            int i2 = 0;
            while (i != -1 && i2 < this.currentSize) {
                if (this.mArrayIndices[i] == arrayRow2.variable.id) {
                    ...
                    remove(arrayRow2.variable, false);
                    ArrayLinkedVariables arrayLinkedVariables = arrayRow2.variables;
                    int i3 = arrayLinkedVariables.mHead;
                    int i4 = 0;
                    while (i3 != -1 && i4 < arrayLinkedVariables.currentSize) {
                        add(this.mCache.mIndexedVariables[arrayLinkedVariables.mArrayIndices[i3]], arrayLinkedVariables.mArrayValues[i3] * f, false);
    ...
    final void updateFromSystem(ArrayRow arrayRow, ArrayRow[] arrayRowArr) {
        int i = this.mHead;
        while (true) {
            int i2 = 0;
            while (i != -1 && i2 < this.currentSize) {
    ...
    final SolverVariable getPivotCandidate(boolean[] zArr, SolverVariable solverVariable) {
        int i = this.mHead;
        int i2 = 0;
