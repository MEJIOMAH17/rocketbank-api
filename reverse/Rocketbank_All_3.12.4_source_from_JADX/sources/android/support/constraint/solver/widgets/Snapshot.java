...
public final class Snapshot {
    ...
    static class Connection {
        ...
        public final void updateFrom(ConstraintWidget constraintWidget) {
            this.mAnchor = constraintWidget.getAnchor(this.mAnchor.mType);
        ...
        public final void applyTo(ConstraintWidget constraintWidget) {
            constraintWidget.getAnchor(this.mAnchor.mType).connect(this.mTarget, this.mMargin, this.mStrengh, this.mCreator);
        }
    }
