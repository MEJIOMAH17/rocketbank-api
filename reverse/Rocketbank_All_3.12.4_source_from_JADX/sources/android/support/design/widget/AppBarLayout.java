...
public class AppBarLayout extends LinearLayout {
    ...
    public static class LayoutParams extends android.widget.LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            attributeSet = context.obtainStyledAttributes(attributeSet, C0039R.styleable.AppBarLayout_Layout);
            this.mScrollFlags = attributeSet.getInt(C0039R.styleable.AppBarLayout_Layout_layout_scrollFlags, 0);
            if (attributeSet.hasValue(C0039R.styleable.AppBarLayout_Layout_layout_scrollInterpolator)) {
                this.mScrollInterpolator = AnimationUtils.loadInterpolator(context, attributeSet.getResourceId(C0039R.styleable.AppBarLayout_Layout_layout_scrollInterpolator, 0));
            }
    ...
    class C08911 implements OnApplyWindowInsetsListener {
        C08911() {
        }
    ...
    public static class Behavior extends HeaderBehavior<AppBarLayout> {
        ...
        protected static class SavedState extends AbsSavedState {
            ...
            static class C00461 implements ClassLoaderCreator<SavedState> {
                C00461() {
                }
        ...
        private void snapToChildIfNeeded(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout) {
            ...
            if (childIndexOnOffset >= 0) {
                ...
                if ((scrollFlags & 17) == 17) {
                    ...
                    topBottomOffsetForScrollingSibling = -appBarLayout.getTotalScrollRange();
                    if (i < topBottomOffsetForScrollingSibling) {
                        i = topBottomOffsetForScrollingSibling;
                    } else if (i > 0) {
                        i = 0;
                    }
                    animateOffsetTo(coordinatorLayout, appBarLayout, i, BitmapDescriptorFactory.HUE_RED);
                }
            }
        }
        ...
        public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout, int i) {
            ...
            if (this.mOffsetToChildIndexOnLayout >= 0 && (pendingAction & 8) == 0) {
                ...
                if ((pendingAction & 2) != 0) {
                    ...
                    if (i2 != 0) {
                        animateOffsetTo(coordinatorLayout, appBarLayout, pendingAction, BitmapDescriptorFactory.HUE_RED);
                    } else {
                        setHeaderTopBottomOffset(coordinatorLayout, appBarLayout, pendingAction);
                    }
                } else if ((pendingAction & 1) != 0) {
                    if (i2 != 0) {
                        animateOffsetTo(coordinatorLayout, appBarLayout, 0, BitmapDescriptorFactory.HUE_RED);
                    } else {
            ...
            pendingAction = getTopAndBottomOffset();
            ...
            setTopAndBottomOffset(pendingAction);
        ...
        int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout, int i, int i2, int i3) {
            ...
            if (i2 == 0 || topBottomOffsetForScrollingSibling < i2 || topBottomOffsetForScrollingSibling > i3) {
                ...
                if (topBottomOffsetForScrollingSibling != i5) {
                    i = appBarLayout.hasChildWithInterpolator() != 0 ? interpolateOffset(appBarLayout, i5) : i5;
                    i2 = setTopAndBottomOffset(i);
                    i4 = topBottomOffsetForScrollingSibling - i5;
                    this.mOffsetDelta = i5 - i;
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        public ScrollingViewBehavior(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            context = context.obtainStyledAttributes(attributeSet, C0039R.styleable.ScrollingViewBehavior_Layout);
            setOverlayTop(context.getDimensionPixelSize(C0039R.styleable.ScrollingViewBehavior_Layout_behavior_overlapTop, 0));
            context.recycle();
        }
    ...
    public AppBarLayout(Context context, AttributeSet attributeSet) {
        ...
        if (VERSION.SDK_INT >= 21) {
            ...
            ViewUtilsLollipop.setStateListAnimatorFromAttrs(this, attributeSet, 0, C0039R.style.Widget_Design_AppBarLayout);
        }
        context = context.obtainStyledAttributes(attributeSet, C0039R.styleable.AppBarLayout, 0, C0039R.style.Widget_Design_AppBarLayout);
        ViewCompat.setBackground(this, context.getDrawable(C0039R.styleable.AppBarLayout_android_background));
        if (context.hasValue(C0039R.styleable.AppBarLayout_expanded) != null) {
            setExpanded(context.getBoolean(C0039R.styleable.AppBarLayout_expanded, false), false, false);
        }
        if (VERSION.SDK_INT >= 21 && context.hasValue(C0039R.styleable.AppBarLayout_elevation) != null) {
            ViewUtilsLollipop.setDefaultAppBarLayoutStateListAnimator(this, (float) context.getDimensionPixelSize(C0039R.styleable.AppBarLayout_elevation, 0));
        }
        if (VERSION.SDK_INT >= 26) {
            if (context.hasValue(C0039R.styleable.AppBarLayout_android_keyboardNavigationCluster) != null) {
                setKeyboardNavigationCluster(context.getBoolean(C0039R.styleable.AppBarLayout_android_keyboardNavigationCluster, false));
            }
            if (context.hasValue(C0039R.styleable.AppBarLayout_android_touchscreenBlocksFocus) != null) {
                setTouchscreenBlocksFocus(context.getBoolean(C0039R.styleable.AppBarLayout_android_touchscreenBlocksFocus, false));
            }
        }
        context.recycle();
        ViewCompat.setOnApplyWindowInsetsListener(this, new C08911());
    }
    ...
    protected int[] onCreateDrawableState(int i) {
        ...
        iArr[0] = this.mCollapsible ? C0039R.attr.state_collapsible : -C0039R.attr.state_collapsible;
        int i2 = (this.mCollapsible && this.mCollapsed) ? C0039R.attr.state_collapsed : -C0039R.attr.state_collapsed;
        iArr[1] = i2;
