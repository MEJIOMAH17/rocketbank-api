...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    class C00572 implements AnimatorUpdateListener {
        C00572() {
        }
    ...
    public static class LayoutParams extends android.widget.FrameLayout.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            context = context.obtainStyledAttributes(attributeSet, C0039R.styleable.CollapsingToolbarLayout_Layout);
            this.mCollapseMode = context.getInt(C0039R.styleable.CollapsingToolbarLayout_Layout_layout_collapseMode, 0);
            setParallaxMultiplier(context.getFloat(C0039R.styleable.CollapsingToolbarLayout_Layout_layout_collapseParallaxMultiplier, DEFAULT_PARALLAX_MULTIPLIER));
            context.recycle();
        }
    ...
    class C09021 implements OnApplyWindowInsetsListener {
        C09021() {
        }
            ...
            for (int i2 = 0; i2 < childCount; i2++) {
                ...
                switch (layoutParams.mCollapseMode) {
                    case 1:
                        ...
                        if (i3 < 0) {
                            maxOffsetForPinChild = 0;
                        } else if (i3 <= maxOffsetForPinChild) {
                            maxOffsetForPinChild = i3;
                        }
                        viewOffsetHelper.setTopAndBottomOffset(maxOffsetForPinChild);
                        break;
                    case 2:
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        context = context.obtainStyledAttributes(attributeSet, C0039R.styleable.CollapsingToolbarLayout, i, C0039R.style.Widget_Design_CollapsingToolbar);
        this.mCollapsingTextHelper.setExpandedTextGravity(context.getInt(C0039R.styleable.CollapsingToolbarLayout_expandedTitleGravity, 8388691));
        this.mCollapsingTextHelper.setCollapsedTextGravity(context.getInt(C0039R.styleable.CollapsingToolbarLayout_collapsedTitleGravity, 8388627));
        attributeSet = context.getDimensionPixelSize(C0039R.styleable.CollapsingToolbarLayout_expandedTitleMargin, 0);
        ...
        if (context.hasValue(C0039R.styleable.CollapsingToolbarLayout_expandedTitleMarginStart) != null) {
            this.mExpandedMarginStart = context.getDimensionPixelSize(C0039R.styleable.CollapsingToolbarLayout_expandedTitleMarginStart, 0);
        }
        if (context.hasValue(C0039R.styleable.CollapsingToolbarLayout_expandedTitleMarginEnd) != null) {
            this.mExpandedMarginEnd = context.getDimensionPixelSize(C0039R.styleable.CollapsingToolbarLayout_expandedTitleMarginEnd, 0);
        }
        if (context.hasValue(C0039R.styleable.CollapsingToolbarLayout_expandedTitleMarginTop) != null) {
            this.mExpandedMarginTop = context.getDimensionPixelSize(C0039R.styleable.CollapsingToolbarLayout_expandedTitleMarginTop, 0);
        }
        if (context.hasValue(C0039R.styleable.CollapsingToolbarLayout_expandedTitleMarginBottom) != null) {
            this.mExpandedMarginBottom = context.getDimensionPixelSize(C0039R.styleable.CollapsingToolbarLayout_expandedTitleMarginBottom, 0);
        }
        this.mCollapsingTitleEnabled = context.getBoolean(C0039R.styleable.CollapsingToolbarLayout_titleEnabled, true);
        setTitle(context.getText(C0039R.styleable.CollapsingToolbarLayout_title));
        this.mCollapsingTextHelper.setExpandedTextAppearance(C0039R.style.TextAppearance_Design_CollapsingToolbar_Expanded);
        this.mCollapsingTextHelper.setCollapsedTextAppearance(C0859R.style.TextAppearance.AppCompat.Widget.ActionBar.Title);
        if (context.hasValue(C0039R.styleable.CollapsingToolbarLayout_expandedTitleTextAppearance) != null) {
            this.mCollapsingTextHelper.setExpandedTextAppearance(context.getResourceId(C0039R.styleable.CollapsingToolbarLayout_expandedTitleTextAppearance, 0));
        }
        if (context.hasValue(C0039R.styleable.CollapsingToolbarLayout_collapsedTitleTextAppearance) != null) {
            this.mCollapsingTextHelper.setCollapsedTextAppearance(context.getResourceId(C0039R.styleable.CollapsingToolbarLayout_collapsedTitleTextAppearance, 0));
        }
        this.mScrimVisibleHeightTrigger = context.getDimensionPixelSize(C0039R.styleable.CollapsingToolbarLayout_scrimVisibleHeightTrigger, -1);
        this.mScrimAnimationDuration = (long) context.getInt(C0039R.styleable.CollapsingToolbarLayout_scrimAnimationDuration, DEFAULT_SCRIM_ANIMATION_DURATION);
        setContentScrim(context.getDrawable(C0039R.styleable.CollapsingToolbarLayout_contentScrim));
        setStatusBarScrim(context.getDrawable(C0039R.styleable.CollapsingToolbarLayout_statusBarScrim));
        this.mToolbarId = context.getResourceId(C0039R.styleable.CollapsingToolbarLayout_toolbarId, -1);
        context.recycle();
        setWillNotDraw(false);
        ViewCompat.setOnApplyWindowInsetsListener(this, new C09021());
    }
    ...
    static ViewOffsetHelper getViewOffsetHelper(View view) {
        ViewOffsetHelper viewOffsetHelper = (ViewOffsetHelper) view.getTag(C0039R.id.view_offset_helper);
        if (viewOffsetHelper != null) {
            return viewOffsetHelper;
        }
        viewOffsetHelper = new ViewOffsetHelper(view);
        view.setTag(C0039R.id.view_offset_helper, viewOffsetHelper);
        return viewOffsetHelper;
    }
    ...
    private void animateScrim(int i) {
        ...
        if (this.mScrimAnimator == null) {
            ...
            this.mScrimAnimator.addUpdateListener(new C00572());
    ...
    public int getScrimVisibleHeightTrigger() {
        ...
        if (minimumHeight > 0) {
            return Math.min((minimumHeight << 1) + systemWindowInsetTop, getHeight());
        }
        return getHeight() / 3;
    }
