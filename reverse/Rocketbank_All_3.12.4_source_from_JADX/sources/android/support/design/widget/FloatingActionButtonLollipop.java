...
class FloatingActionButtonLollipop extends FloatingActionButtonImpl {
    ...
    void onElevationsChanged(float f, float f2) {
        if (VERSION.SDK_INT != 21) {
            ...
            arrayList.add(ObjectAnimator.ofFloat(this.mView, View.TRANSLATION_Z, new float[]{BitmapDescriptorFactory.HUE_RED}).setDuration(100));
            ...
            f = new AnimatorSet();
            f.play(ObjectAnimator.ofFloat(this.mView, "elevation", new float[]{BitmapDescriptorFactory.HUE_RED}).setDuration(0)).with(ObjectAnimator.ofFloat(this.mView, View.TRANSLATION_Z, new float[]{BitmapDescriptorFactory.HUE_RED}).setDuration(0));
            ...
            if (this.mView.isFocused() == null) {
                if (this.mView.isPressed() == null) {
                    this.mView.setTranslationZ(BitmapDescriptorFactory.HUE_RED);
                }
            }
            this.mView.setTranslationZ(f2);
        } else {
            this.mView.setElevation(BitmapDescriptorFactory.HUE_RED);
            this.mView.setTranslationZ(BitmapDescriptorFactory.HUE_RED);
        }
