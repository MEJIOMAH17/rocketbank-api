...
public class BottomSheetBehavior<V extends View> extends Behavior<V> {
    ...
    private final Callback mDragCallback = new C08982();
    boolean mHideable;
    ...
    private class SettleRunnable implements Runnable {
        ...
        public void run() {
            if (BottomSheetBehavior.this.mViewDragHelper == null || !BottomSheetBehavior.this.mViewDragHelper.continueSettling$138603()) {
    ...
    class C08982 extends Callback {
        ...
        public int clampViewPositionVertical(View view, int i, int i2) {
            view = BottomSheetBehavior.this.mMinOffset;
            i2 = BottomSheetBehavior.this.mHideable != 0 ? BottomSheetBehavior.this.mParentHeight : BottomSheetBehavior.this.mMaxOffset;
            if (i < view) {
                return view;
            }
            return i > i2 ? i2 : i;
    ...
    public BottomSheetBehavior(Context context, AttributeSet attributeSet) {
        ...
        attributeSet = context.obtainStyledAttributes(attributeSet, C0039R.styleable.BottomSheetBehavior_Layout);
        TypedValue peekValue = attributeSet.peekValue(C0039R.styleable.BottomSheetBehavior_Layout_behavior_peekHeight);
        if (peekValue == null || peekValue.data != -1) {
            setPeekHeight(attributeSet.getDimensionPixelSize(C0039R.styleable.BottomSheetBehavior_Layout_behavior_peekHeight, -1));
        } else {
            setPeekHeight(peekValue.data);
        }
        setHideable(attributeSet.getBoolean(C0039R.styleable.BottomSheetBehavior_Layout_behavior_hideable, false));
        setSkipCollapsed(attributeSet.getBoolean(C0039R.styleable.BottomSheetBehavior_Layout_behavior_skipCollapsed, false));
    ...
    public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, V v, int i) {
        ...
        if (this.mPeekHeightAuto != 0) {
            if (this.mPeekHeightMin == 0) {
                this.mPeekHeightMin = coordinatorLayout.getResources().getDimensionPixelSize(C0039R.dimen.design_bottom_sheet_peek_height_min);
            }
