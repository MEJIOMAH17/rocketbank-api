...
public class NavigationMenuItemView extends ForegroundLinearLayout implements ItemView {
    ...
    class C08891 extends AccessibilityDelegateCompat {
        C08891() {
        }
    ...
    public NavigationMenuItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mAccessibilityDelegate = new C08891();
        setOrientation(null);
        LayoutInflater.from(context).inflate(C0039R.layout.design_navigation_menu_item, this, true);
        this.mIconSize = context.getResources().getDimensionPixelSize(C0039R.dimen.design_navigation_icon_size);
        this.mTextView = (CheckedTextView) findViewById(C0039R.id.design_menu_item_text);
    ...
    private void setActionView(View view) {
        if (view != null) {
            if (this.mActionArea == null) {
                this.mActionArea = (FrameLayout) ((ViewStub) findViewById(C0039R.id.design_menu_item_action_area_stub)).inflate();
            }
            this.mActionArea.removeAllViews();
    ...
    private StateListDrawable createDefaultBackground() {
        ...
        if (!getContext().getTheme().resolveAttribute(C0859R.attr.colorControlHighlight, typedValue, true)) {
            return null;
        }
    ...
    public void setIcon(Drawable drawable) {
        if (drawable != null) {
            ...
            if (this.mEmptyDrawable == null) {
                ...
                int i = C0039R.drawable.navigation_empty_icon;
                Theme theme = getContext().getTheme();
                if (VERSION.SDK_INT >= 21) {
                    drawable = drawable.getDrawable(i, theme);
                } else {
