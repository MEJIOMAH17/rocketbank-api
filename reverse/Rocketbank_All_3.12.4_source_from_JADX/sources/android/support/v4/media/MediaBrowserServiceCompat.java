...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    private class ConnectionRecord implements DeathRecipient {
        ...
        public void binderDied() {
            MediaBrowserServiceCompat.this.mHandler.post(new C01401());
        }
    }
...
*/
                    ...
                    L_0x0038:
                        ...
                        r0 = r3;	 Catch:{ RemoteException -> 0x0063 }
                        r0.onConnectFailed();	 Catch:{ RemoteException -> 0x0063 }
                        return;
                    L_0x0063:
                        r0 = "MBServiceCompat";
                        r1 = new java.lang.StringBuilder;
                        ...
                        return;
                    L_0x0079:
                        r2 = android.support.v4.media.MediaBrowserServiceCompat.ServiceBinderImpl.this;	 Catch:{ RemoteException -> 0x00a6 }
                        r2 = android.support.v4.media.MediaBrowserServiceCompat.this;	 Catch:{ RemoteException -> 0x00a6 }
                        r2 = r2.mConnections;	 Catch:{ RemoteException -> 0x00a6 }
                        r2.put(r0, r1);	 Catch:{ RemoteException -> 0x00a6 }
                        r2 = 0;	 Catch:{ RemoteException -> 0x00a6 }
                        r0.linkToDeath(r1, r2);	 Catch:{ RemoteException -> 0x00a6 }
                        r2 = android.support.v4.media.MediaBrowserServiceCompat.ServiceBinderImpl.this;	 Catch:{ RemoteException -> 0x00a6 }
                        r2 = android.support.v4.media.MediaBrowserServiceCompat.this;	 Catch:{ RemoteException -> 0x00a6 }
                        r2 = r2.mSession;	 Catch:{ RemoteException -> 0x00a6 }
                        if (r2 == 0) goto L_0x00a5;	 Catch:{ RemoteException -> 0x00a6 }
                    L_0x008e:
                        r2 = r3;	 Catch:{ RemoteException -> 0x00a6 }
                        r3 = r1.root;	 Catch:{ RemoteException -> 0x00a6 }
                        r3 = r3.getRootId();	 Catch:{ RemoteException -> 0x00a6 }
                        r4 = android.support.v4.media.MediaBrowserServiceCompat.ServiceBinderImpl.this;	 Catch:{ RemoteException -> 0x00a6 }
                        r4 = android.support.v4.media.MediaBrowserServiceCompat.this;	 Catch:{ RemoteException -> 0x00a6 }
                        r4 = r4.mSession;	 Catch:{ RemoteException -> 0x00a6 }
                        r1 = r1.root;	 Catch:{ RemoteException -> 0x00a6 }
                        r1 = r1.getExtras();	 Catch:{ RemoteException -> 0x00a6 }
                        r2.onConnect(r3, r4, r1);	 Catch:{ RemoteException -> 0x00a6 }
                    L_0x00a5:
                        return;
                    L_0x00a6:
                        r1 = "MBServiceCompat";
        ...
        public void removeSubscription(final String str, final IBinder iBinder, final ServiceCallbacks serviceCallbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                public void run() {
                    ...
                    if (connectionRecord == null) {
                        String str = MediaBrowserServiceCompat.TAG;
                        StringBuilder stringBuilder = new StringBuilder("removeSubscription for callback that isn't registered id=");
...
*/
    ...
    void performLoadChildren(String str, ConnectionRecord connectionRecord, Bundle bundle) {
        ...
        final String str2 = str;
        final Bundle bundle2 = bundle;
        Result c09201 = new Result<List<MediaItem>>(str) {
...
*/
            ...
            L_0x004a:
                ...
                r0 = r0.callbacks;	 Catch:{ RemoteException -> 0x0056 }
                r1 = r4;	 Catch:{ RemoteException -> 0x0056 }
                r2 = r5;	 Catch:{ RemoteException -> 0x0056 }
                r0.onLoadChildren(r1, r4, r2);	 Catch:{ RemoteException -> 0x0056 }
                return;
            L_0x0056:
                r4 = "MBServiceCompat";
                r0 = new java.lang.StringBuilder;
        ...
        if (bundle == null) {
            onLoadChildren(str, c09201);
        } else {
            onLoadChildren(str, c09201, bundle);
        }
        this.mCurConnection = null;
        if (c09201.isDone() == null) {
    ...
    void performLoadItem(String str, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        Result c09212 = new Result<MediaItem>(str) {
            void onResultSent(MediaItem mediaItem) {
                if ((getFlags() & 2) != 0) {
        ...
        this.mCurConnection = connectionRecord;
        onLoadItem(str, c09212);
        this.mCurConnection = null;
        if (c09212.isDone() == null) {
    ...
    void performSearch(String str, Bundle bundle, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        Result c09223 = new Result<List<MediaItem>>(str) {
            void onResultSent(List<MediaItem> list) {
                if ((getFlags() & 4) == 0) {
                    if (list != null) {
                        Bundle bundle = new Bundle();
        ...
        this.mCurConnection = connectionRecord;
        onSearch(str, bundle, c09223);
        this.mCurConnection = null;
        if (c09223.isDone() == null) {
    ...
    void performCustomAction(String str, Bundle bundle, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        Result c09234 = new Result<Bundle>(str) {
        ...
        this.mCurConnection = connectionRecord;
        onCustomAction(str, bundle, c09234);
        this.mCurConnection = null;
        if (c09234.isDone() == null) {
