...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final Creator<PlaybackStateCompat> CREATOR = new C01641();
    ...
    static class C01641 implements Creator<PlaybackStateCompat> {
        C01641() {
        }
    ...
    public static final class CustomAction implements Parcelable {
        public static final Creator<CustomAction> CREATOR = new C01651();
        ...
        static class C01651 implements Creator<CustomAction> {
            C01651() {
            }
