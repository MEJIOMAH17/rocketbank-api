...
public class AppLaunchChecker {
    ...
    public static void onActivityCreate(Activity activity) {
        ...
        if (!sharedPreferences.getBoolean(KEY_STARTED_FROM_LAUNCHER, false)) {
            ...
            if (activity != null && "android.intent.action.MAIN".equals(activity.getAction()) && (activity.hasCategory("android.intent.category.LAUNCHER") || activity.hasCategory("android.intent.category.LEANBACK_LAUNCHER") != null)) {
