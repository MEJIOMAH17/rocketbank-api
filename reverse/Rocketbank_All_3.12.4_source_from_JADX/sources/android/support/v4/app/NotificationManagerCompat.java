...
public final class NotificationManagerCompat {
    ...
    private static class SideChannelManager implements ServiceConnection, Callback {
        ...
        public void onServiceDisconnected(ComponentName componentName) {
            if (Log.isLoggable(NotificationManagerCompat.TAG, 3)) {
                Log.d(NotificationManagerCompat.TAG, "Disconnected from service ".concat(String.valueOf(componentName)));
            }
...
*/
        ...
        L_0x004f:
            r2 = "NotifManCompat";	 Catch:{ DeadObjectException -> 0x0088, RemoteException -> 0x0071 }
            r2 = android.util.Log.isLoggable(r2, r1);	 Catch:{ DeadObjectException -> 0x0088, RemoteException -> 0x0071 }
            if (r2 == 0) goto L_0x0066;	 Catch:{ DeadObjectException -> 0x0088, RemoteException -> 0x0071 }
        L_0x0057:
            r2 = "NotifManCompat";	 Catch:{ DeadObjectException -> 0x0088, RemoteException -> 0x0071 }
            r3 = "Sending task ";	 Catch:{ DeadObjectException -> 0x0088, RemoteException -> 0x0071 }
            r4 = java.lang.String.valueOf(r0);	 Catch:{ DeadObjectException -> 0x0088, RemoteException -> 0x0071 }
            r3 = r3.concat(r4);	 Catch:{ DeadObjectException -> 0x0088, RemoteException -> 0x0071 }
            android.util.Log.d(r2, r3);	 Catch:{ DeadObjectException -> 0x0088, RemoteException -> 0x0071 }
        L_0x0066:
            r2 = r6.service;	 Catch:{ DeadObjectException -> 0x0088, RemoteException -> 0x0071 }
            r0.send(r2);	 Catch:{ DeadObjectException -> 0x0088, RemoteException -> 0x0071 }
            r0 = r6.taskQueue;	 Catch:{ DeadObjectException -> 0x0088, RemoteException -> 0x0071 }
            r0.remove();	 Catch:{ DeadObjectException -> 0x0088, RemoteException -> 0x0071 }
            goto L_0x0045;
        L_0x0071:
            r0 = move-exception;
            r1 = "NotifManCompat";
