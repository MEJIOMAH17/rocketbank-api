...
public class FragmentActivity extends BaseFragmentActivityApi16 implements OnRequestPermissionsResultCallback, RequestPermissionsRequestCodeValidator {
    ...
    final Handler mHandler = new C00941();
    ...
    protected void onActivityResult(int i, int i2, Intent intent) {
        ...
        if (i3 != 0) {
            ...
            if (findFragmentByWho == null) {
                Log.w(TAG, "Activity result no fragment exists for who: ".concat(String.valueOf(str)));
                return;
            } else {
                findFragmentByWho.onActivityResult(i & ChatFragment.TYPE_MESSAGE_TYPING, i2, intent);
                return;
            }
        }
    ...
    public void onRequestPermissionsResult(int i, String[] strArr, int[] iArr) {
        this.mFragments.noteStateNotSaved();
        int i2 = (i >> 16) & ChatFragment.TYPE_MESSAGE_TYPING;
        if (i2 != 0) {
            i2--;
            ...
            findFragmentByWho.onRequestPermissionsResult(i & ChatFragment.TYPE_MESSAGE_TYPING, strArr, iArr);
        }
    }
    ...
    public void startActivityFromFragment(Fragment fragment, Intent intent, int i, Bundle bundle) {
        ...
        if (i == -1) {
            ...
            BaseFragmentActivityApi14.checkForValidRequestCode(i);
            ActivityCompat.startActivityForResult(this, intent, ((allocateRequestIndex(fragment) + 1) << 16) + (i & ChatFragment.TYPE_MESSAGE_TYPING), bundle);
            this.mStartedActivityFromFragment = false;
        }
    }
    ...
    public void startIntentSenderFromFragment(Fragment fragment, IntentSender intentSender, int i, Intent intent, int i2, int i3, int i4, Bundle bundle) throws SendIntentException {
        ...
        if (i5 == -1) {
            ...
            ActivityCompat.startIntentSenderForResult(r9, intentSender, ((allocateRequestIndex(fragment) + 1) << 16) + (ChatFragment.TYPE_MESSAGE_TYPING & i5), intent, i2, i3, i4, bundle);
            r9.mStartedIntentSenderFromFragment = false;
        }
    }
    ...
    void requestPermissionsFromFragment(Fragment fragment, String[] strArr, int i) {
        ...
        try {
            ...
            ActivityCompat.requestPermissions(this, strArr, ((allocateRequestIndex(fragment) + 1) << 16) + (i & ChatFragment.TYPE_MESSAGE_TYPING));
        } finally {
