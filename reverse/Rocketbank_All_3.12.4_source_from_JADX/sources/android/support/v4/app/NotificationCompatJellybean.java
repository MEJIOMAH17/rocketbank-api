...
class NotificationCompatJellybean {
    ...
    public static Action readAction(int i, CharSequence charSequence, PendingIntent pendingIntent, Bundle bundle) {
        ...
        return new Action(i, charSequence, pendingIntent, bundle, remoteInputArr, remoteInputArr2, z);
    }
    ...
    static Action getActionFromBundle(Bundle bundle) {
        ...
        return new Action(bundle.getInt(KEY_ICON), bundle.getCharSequence("title"), (PendingIntent) bundle.getParcelable(KEY_ACTION_INTENT), bundle.getBundle("extras"), fromBundleArray(getBundleArrayFromBundle(bundle, KEY_REMOTE_INPUTS)), fromBundleArray(getBundleArrayFromBundle(bundle, KEY_DATA_ONLY_REMOTE_INPUTS)), z);
    }
