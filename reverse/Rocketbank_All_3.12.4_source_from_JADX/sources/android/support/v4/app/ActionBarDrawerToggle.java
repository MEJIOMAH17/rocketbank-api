...
*/
    ...
    private class SlideDrawable extends InsetDrawable implements Callback {
        ...
        public void draw(Canvas canvas) {
            ...
            canvas.translate((((-this.mOffset) * width) * this.mPosition) * ((float) i), BitmapDescriptorFactory.HUE_RED);
    ...
    public boolean onOptionsItemSelected(MenuItem menuItem) {
        ...
        if (this.mDrawerLayout.isDrawerVisible$134632() != null) {
    ...
    public void onDrawerSlide(View view, float f) {
        ...
        if (f > 0.5f) {
            view = Math.max(view, Math.max(BitmapDescriptorFactory.HUE_RED, f - 0.5f) * 2.0f);
        } else {
