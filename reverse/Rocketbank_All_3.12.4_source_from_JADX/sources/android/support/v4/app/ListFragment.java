...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C01172();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C01161();
    ...
    class C01172 implements OnItemClickListener {
        C01172() {
        }
