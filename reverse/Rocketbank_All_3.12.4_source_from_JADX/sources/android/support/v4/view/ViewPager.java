...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C01851();
    ...
    private static final Interpolator sInterpolator = new C01862();
    ...
    private final Runnable mEndScrollRunnable = new C01873();
    ...
    static class C01851 implements Comparator<ItemInfo> {
        C01851() {
        }
    ...
    static class C01862 implements Interpolator {
    ...
    class C09364 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C09364());
    }
...
*/
            ...
            if (action != 1) {
                ...
                if (action == 0) {
                    ...
                    if (action != -1) {
                        ...
                        if (f == BitmapDescriptorFactory.HUE_RED || isGutterDrag(view.mLastMotionX, f) || !canScroll(view, false, (int) f, (int) x2, (int) y)) {
                            if (abs > ((float) view.mTouchSlop) && abs * 0.5f > abs2) {
                                view.mIsBeingDragged = true;
                                requestParentDisallowInterceptTouchEvent(true);
                                setScrollState(1);
                                view.mLastMotionX = f > BitmapDescriptorFactory.HUE_RED ? view.mInitialMotionX + ((float) view.mTouchSlop) : view.mInitialMotionX - ((float) view.mTouchSlop);
                                view.mLastMotionY = y;
                                setScrollingCacheEnabled(true);
    ...
    public void fakeDragBy(float f) {
        if (!this.mFakeDragging) {
            ...
            scrollTo(i, getScrollY());
            pageScrolled(i);
            f = MotionEvent.obtain(this.mFakeDragBeginTime, SystemClock.uptimeMillis(), 2, this.mLastMotionX, BitmapDescriptorFactory.HUE_RED, 0);
