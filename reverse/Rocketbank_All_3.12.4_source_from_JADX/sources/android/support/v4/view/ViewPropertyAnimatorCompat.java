...
public final class ViewPropertyAnimatorCompat {
    ...
    /* renamed from: x */
    public final ViewPropertyAnimatorCompat m0x(float f) {
        View view = (View) this.mView.get();
        if (view != null) {
            view.animate().x(f);
        }
    ...
    /* renamed from: y */
    public final ViewPropertyAnimatorCompat m1y(float f) {
        View view = (View) this.mView.get();
        if (view != null) {
            view.animate().y(f);
        }
    ...
    /* renamed from: z */
    public final ViewPropertyAnimatorCompat m2z(float f) {
        View view = (View) this.mView.get();
        if (view != null && VERSION.SDK_INT >= 21) {
            view.animate().z(f);
        }
