...
public class AccessibilityNodeInfoCompat {
    ...
    public static class RangeInfoCompat {
        ...
        public static RangeInfoCompat obtain(int i, float f, float f2, float f3) {
            ...
            return new RangeInfoCompat(BitmapDescriptorFactory.HUE_RED);
        }
        ...
        public float getCurrent() {
            return VERSION.SDK_INT >= 19 ? ((RangeInfo) this.mInfo).getCurrent() : BitmapDescriptorFactory.HUE_RED;
        }

        public float getMax() {
            return VERSION.SDK_INT >= 19 ? ((RangeInfo) this.mInfo).getMax() : BitmapDescriptorFactory.HUE_RED;
        }

        public float getMin() {
            return VERSION.SDK_INT >= 19 ? ((RangeInfo) this.mInfo).getMin() : BitmapDescriptorFactory.HUE_RED;
        }
