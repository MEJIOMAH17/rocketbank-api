...
public class Base64 {
    ...
    public static java.lang.String encodeBytes(byte[] r1) {
...
*/
        /*
        r0 = r1.length;	 Catch:{ IOException -> 0x0006 }
        r1 = encodeBytes$5fb0bea7(r1, r0);	 Catch:{ IOException -> 0x0006 }
        goto L_0x0007;
    L_0x0006:
        r1 = 0;
    L_0x0007:
        return r1;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.java_websocket.util.Base64.encodeBytes(byte[]):java.lang.String");
    }

    private static byte[] encode3to4$45536f7a(byte[] bArr, int i, int i2, byte[] bArr2, int i3) {
    ...
    private static java.lang.String encodeBytes$5fb0bea7(byte[] r7, int r8) throws java.io.IOException {
        /* JADX: method processing error */
/*
Error: java.lang.NullPointerException
	at jadx.core.dex.visitors.regions.ProcessTryCatchRegions.searchTryCatchDominators(ProcessTryCatchRegions.java:75)
...
*/
    ...
    L_0x0002:
        ...
        r8 = "Cannot serialize a null array.";
        r7.<init>(r8);
        throw r7;
    L_0x000a:
    ...
    L_0x0023:
        ...
        r5 = "Cannot have offset of %d and length of %d with array of length %d";
        ...
        r2[r1] = r7;
        r7 = java.lang.String.format(r5, r2);
        r4.<init>(r7);
        throw r4;
    L_0x0044:
        r4 = r8 / 3;
    ...
    L_0x0058:
        encode3to4$45536f7a(r7, r5, r2, r1, r6);
        r5 = r5 + 3;
        r6 = r6 + 4;
        goto L_0x0056;
    L_0x0060:
    ...
    L_0x0062:
        r8 = r8 - r5;
        encode3to4$45536f7a(r7, r5, r8, r1, r6);
        r6 = r6 + 4;
    L_0x0068:
        r7 = r1.length;
        r7 = r7 - r0;
    ...
    L_0x0072:
        r7 = r1;
    L_0x0073:
        r8 = new java.lang.String;	 Catch:{ UnsupportedEncodingException -> 0x007b }
        r0 = "US-ASCII";	 Catch:{ UnsupportedEncodingException -> 0x007b }
        r8.<init>(r7, r0);	 Catch:{ UnsupportedEncodingException -> 0x007b }
        return r8;
    L_0x007b:
        ...
        return r8;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.java_websocket.util.Base64.encodeBytes$5fb0bea7(byte[], int):java.lang.String");
    }
}
