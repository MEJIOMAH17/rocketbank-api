...
public class Completable {
    static final Completable COMPLETE = new Completable(new C21361(), false);
    static final Completable NEVER = new Completable(new C21372(), false);
    ...
    static class C21361 implements OnSubscribe {
        C21361() {
        }
    ...
    static class C21372 implements OnSubscribe {
        C21372() {
        }
    ...
    public static Completable amb(final Completable... completableArr) {
        ...
        return create(new OnSubscribe() {
            public final void call(final CompletableSubscriber completableSubscriber) {
                ...
                CompletableSubscriber c16971 = new CompletableSubscriber() {
                ...
                while (i < length) {
                    ...
                    if (!compositeSubscription.isUnsubscribed()) {
                        ...
                        if (!atomicBoolean.get()) {
                            if (!compositeSubscription.isUnsubscribed()) {
                                completable.unsafeSubscribe(c16971);
                                i++;
                            }
                        }
                        return;
        ...
        return create(new OnSubscribe() {
            public final void call(final CompletableSubscriber completableSubscriber) {
                ...
                try {
                    ...
                    final AtomicBoolean atomicBoolean = new AtomicBoolean();
                    CompletableSubscriber c17001 = new CompletableSubscriber() {
                        public void onCompleted() {
                            if (atomicBoolean.compareAndSet(false, true)) {
                                compositeSubscription.unsubscribe();
                                completableSubscriber.onCompleted();
                                ...
                                if (!atomicBoolean.get()) {
                                    if (!compositeSubscription.isUnsubscribed()) {
                                        try {
                                            ...
                                            if (!atomicBoolean.get()) {
                                                if (!compositeSubscription.isUnsubscribed()) {
                                                    completable.unsafeSubscribe(c17001);
                                                    z = false;
                                                }
                                            }
                                            return;
    ...
    public static Completable create(OnSubscribe onSubscribe) {
        ...
        } catch (OnSubscribe onSubscribe2) {
            throw onSubscribe2;
        } catch (OnSubscribe onSubscribe22) {
            RxJavaHooks.onError(onSubscribe22);
            onSubscribe22 = toNpe(onSubscribe22);
        }
    }
    ...
    public static Completable fromObservable(final Observable<?> observable) {
        ...
        return create(new OnSubscribe() {
            public final void call(final CompletableSubscriber completableSubscriber) {
                Object c18441 = new Subscriber<Object>() {
                ...
                completableSubscriber.onSubscribe(c18441);
                observable.unsafeSubscribe(c18441);
            }
        });
    }
    ...
    public static Completable fromSingle(final Single<?> single) {
        ...
        return create(new OnSubscribe() {
            public final void call(final CompletableSubscriber completableSubscriber) {
                SingleSubscriber c18451 = new SingleSubscriber<Object>() {
                    public void onError(Throwable th) {
                        completableSubscriber.onError(th);
                    }
                ...
                completableSubscriber.onSubscribe(c18451);
                single.subscribe(c18451);
            }
        });
    }
                ...
                try {
                    ...
                    try {
                        ...
                        completable.unsafeSubscribe(new CompletableSubscriber() {
                            ...
                            class C20571 implements Action0 {
                                C20571() {
                                }
                            ...
                            public void onSubscribe(Subscription subscription) {
                                this.f757d = subscription;
                                completableSubscriber.onSubscribe(Subscriptions.create(new C20571()));
                            }
                        });
                    } catch (Throwable th2) {
                        Exceptions.throwIfFatal(th);
    ...
    public final boolean await(long j, TimeUnit timeUnit) {
        ...
        try {
            j = countDownLatch.await(j, timeUnit);
            if (!(j == null || thArr[0] == null)) {
                Exceptions.propagate(thArr[0]);
            }
            return j;
        } catch (long j2) {
            throw Exceptions.propagate(j2);
        }
    }
        ...
        return create(new OnSubscribe() {
            public void call(final CompletableSubscriber completableSubscriber) {
                ...
                Completable.this.unsafeSubscribe(new CompletableSubscriber() {
                    ...
                    public void onCompleted() {
                        compositeSubscription.add(createWorker.schedule(new C20581(), j2, timeUnit2));
                    }
    ...
    public final Throwable get(long j, TimeUnit timeUnit) {
        ...
        try {
            if (countDownLatch.await(j, timeUnit) != null) {
                return thArr[0];
            }
        ...
        return create(new OnSubscribe() {
            public void call(CompletableSubscriber completableSubscriber) {
                try {
                    ...
                    completableSubscriber22 = Completable.toNpe(completableSubscriber22);
                }
            }
        });
    }
    ...
    public final Completable observeOn(final Scheduler scheduler) {
        ...
        return create(new OnSubscribe() {
            public void call(final CompletableSubscriber completableSubscriber) {
                final Object subscriptionList = new SubscriptionList();
                final Object createWorker = scheduler.createWorker();
                subscriptionList.add(createWorker);
                completableSubscriber.onSubscribe(subscriptionList);
                Completable.this.unsafeSubscribe(new CompletableSubscriber() {

                    /* renamed from: rx.Completable$24$1$1 */
                    class C20611 implements Action0 {
                        C20611() {
                        }
                    ...
                    public void onCompleted() {
                        createWorker.schedule(new C20611());
                    }
            ...
            public void call(final CompletableSubscriber completableSubscriber) {
                Completable.this.unsafeSubscribe(new CompletableSubscriber() {
                    ...
                    public void onError(Throwable th) {
                        int i = 0;
                        try {
                            i = ((Boolean) func1.call(th)).booleanValue();
                        } catch (Throwable th2) {
                            Exceptions.throwIfFatal(th2);
                            th = new CompositeException(Arrays.asList(new Throwable[]{th, th2}));
                        }
        ...
        return create(new OnSubscribe() {
            public void call(final CompletableSubscriber completableSubscriber) {
                ...
                Completable.this.unsafeSubscribe(new CompletableSubscriber() {
                    ...
                    class C16951 implements CompletableSubscriber {
                        C16951() {
                        }
                    ...
                    public void onError(Throwable th) {
                        try {
                            ...
                            completable.unsafeSubscribe(new C16951());
                        } catch (Throwable th2) {
                            completableSubscriber.onError(new CompositeException(Arrays.asList(new Throwable[]{th, th2})));
                        }
                    }
    ...
    public final Subscription subscribe() {
        final Subscription multipleAssignmentSubscription = new MultipleAssignmentSubscription();
        unsafeSubscribe(new CompletableSubscriber() {
            public void onCompleted() {
    ...
    public final void unsafeSubscribe(CompletableSubscriber completableSubscriber) {
        ...
        try {
            ...
            Exceptions.throwIfFatal(completableSubscriber22);
            completableSubscriber22 = RxJavaHooks.onCompletableError(completableSubscriber22);
            RxJavaHooks.onError(completableSubscriber22);
            completableSubscriber22 = toNpe(completableSubscriber22);
        }
    }
    ...
    private <T> void unsafeSubscribe(final Subscriber<T> subscriber, boolean z) {
        ...
        if (z) {
            try {
                subscriber.onStart();
            } catch (Subscriber<T> subscriber2) {
                throw subscriber2;
            } catch (Subscriber<T> subscriber22) {
                Exceptions.throwIfFatal(subscriber22);
                subscriber22 = RxJavaHooks.onObservableError(subscriber22);
                RxJavaHooks.onError(subscriber22);
                subscriber22 = toNpe(subscriber22);
            }
        }
        unsafeSubscribe(new CompletableSubscriber() {
            public void onCompleted() {
            ...
            public void onSubscribe(Subscription subscription) {
                subscriber22.add(subscription);
            }
        });
        RxJavaHooks.onObservableReturn(subscriber22);
    }
    ...
    public final <T> Observable<T> toObservable() {
        return Observable.create(new rx.Observable.OnSubscribe<T>() {
            public void call(Subscriber<? super T> subscriber) {
                Completable.this.unsafeSubscribe((Subscriber) subscriber);
            }
        });
    }
