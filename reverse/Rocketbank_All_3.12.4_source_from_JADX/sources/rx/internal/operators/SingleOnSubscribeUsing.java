    ...
    public final void call(final SingleSubscriber<? super T> singleSubscriber) {
        try {
            ...
            try {
                ...
                SingleSubscriber c19551 = new SingleSubscriber<T>() {
                    public void onSuccess(T t) {
                        if (SingleOnSubscribeUsing.this.disposeEagerly) {
                            try {
                                ...
                                singleSubscriber.onError(t2);
                                return;
                            }
                        }
                        singleSubscriber.onSuccess(t2);
                        if (SingleOnSubscribeUsing.this.disposeEagerly == null) {
                            try {
                                SingleOnSubscribeUsing.this.disposeAction.call(call);
                            } catch (T t22) {
                                Exceptions.throwIfFatal(t22);
                                RxJavaHooks.onError(t22);
                            }
                        }
                    }
                ...
                singleSubscriber.add(c19551);
                single.subscribe(c19551);
            } catch (Throwable th) {
