...
public class ObjectAnimatorCompat {
    ...
    public static <T> ObjectAnimator ofArgb(T t, Property<T, Integer> property, int... iArr) {
        if (VERSION.SDK_INT >= 21) {
            return ObjectAnimatorCompatLollipop.ofArgb((Object) t, (Property) property, iArr);
        }
        return ObjectAnimatorCompatBase.ofArgb((Object) t, (Property) property, iArr);
    }
    ...
    public static <T> ObjectAnimator ofFloat(T t, Property<T, Float> property, Property<T, Float> property2, Path path) {
        if (VERSION.SDK_INT >= 21) {
            return ObjectAnimatorCompatLollipop.ofFloat((Object) t, (Property) property, (Property) property2, path);
        }
        return ObjectAnimatorCompatBase.ofFloat((Object) t, (Property) property, (Property) property2, path);
    }
    ...
    public static <T> ObjectAnimator ofInt(T t, Property<T, Integer> property, Property<T, Integer> property2, Path path) {
        if (VERSION.SDK_INT >= 21) {
            return ObjectAnimatorCompatLollipop.ofInt((Object) t, (Property) property, (Property) property2, path);
        }
        return ObjectAnimatorCompatBase.ofInt((Object) t, (Property) property, (Property) property2, path);
    }
}
