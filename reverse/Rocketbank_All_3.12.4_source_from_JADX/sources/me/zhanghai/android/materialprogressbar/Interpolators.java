...
class Interpolators {
    ...
    public static class INDETERMINATE_HORIZONTAL_RECT1_SCALE_X {
        ...
        static {
            ...
            PATH_INDETERMINATE_HORIZONTAL_RECT1_SCALE_X.lineTo(0.3665f, BitmapDescriptorFactory.HUE_RED);
    ...
    public static class INDETERMINATE_HORIZONTAL_RECT1_TRANSLATE_X {
        ...
        static {
            ...
            path.moveTo(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED);
            PATH_INDETERMINATE_HORIZONTAL_RECT1_TRANSLATE_X.lineTo(0.2f, BitmapDescriptorFactory.HUE_RED);
            PATH_INDETERMINATE_HORIZONTAL_RECT1_TRANSLATE_X.cubicTo(0.39583334f, BitmapDescriptorFactory.HUE_RED, 0.47484508f, 0.20679761f, 0.59166664f, 0.41708294f);
    ...
    public static class INDETERMINATE_HORIZONTAL_RECT2_TRANSLATE_X {
        ...
        static {
            ...
            path.moveTo(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED);
            PATH_INDETERMINATE_HORIZONTAL_RECT2_TRANSLATE_X.cubicTo(0.0375f, BitmapDescriptorFactory.HUE_RED, 0.12876461f, 0.0895381f, 0.25f, 0.21855351f);
    ...
    public static class TRIM_PATH_END {
        ...
        static {
            ...
            path.cubicTo(0.2f, BitmapDescriptorFactory.HUE_RED, 0.1f, 1.0f, 0.5f, 1.0f);
    ...
    public static class TRIM_PATH_START {
        ...
        static {
            ...
            PATH_TRIM_PATH_START.cubicTo(0.7f, BitmapDescriptorFactory.HUE_RED, 0.6f, 1.0f, 1.0f, 1.0f);
        }
    }
