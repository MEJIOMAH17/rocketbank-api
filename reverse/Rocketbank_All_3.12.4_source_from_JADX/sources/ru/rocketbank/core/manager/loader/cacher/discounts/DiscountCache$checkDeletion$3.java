...
final class DiscountCache$checkDeletion$3 implements Runnable {
    final /* synthetic */ ObjectRef $currentCategory;
    final /* synthetic */ int $i;
    final /* synthetic */ DiscountCache this$0;

    DiscountCache$checkDeletion$3(DiscountCache discountCache, ObjectRef objectRef, int i) {
    ...
    public final void run() {
        ...
        listener.onDiscountRemoved((Category) this.$currentCategory.element, this.$i);
    }
}
