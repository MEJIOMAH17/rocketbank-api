...
final class DiscountCache$checkAddition$2 implements Runnable {
    final /* synthetic */ ObjectRef $currentCategory;
    final /* synthetic */ int $i;
    final /* synthetic */ DiscountCache this$0;

    DiscountCache$checkAddition$2(DiscountCache discountCache, ObjectRef objectRef, int i) {
    ...
    public final void run() {
        ...
        listener.onCategoryAdded((Category) this.$currentCategory.element, this.$i);
    }
}
