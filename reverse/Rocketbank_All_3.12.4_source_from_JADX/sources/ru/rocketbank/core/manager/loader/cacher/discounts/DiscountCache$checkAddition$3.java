...
final class DiscountCache$checkAddition$3 implements Runnable {
    final /* synthetic */ ObjectRef $currentCategory;
    final /* synthetic */ int $i;
    final /* synthetic */ DiscountCache this$0;

    DiscountCache$checkAddition$3(DiscountCache discountCache, ObjectRef objectRef, int i) {
    ...
    public final void run() {
        ...
        listener.onDiscountAdded((Category) this.$currentCategory.element, this.$i);
    }
}
