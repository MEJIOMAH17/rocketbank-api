...
final class RxPresenter$singleCallOrReplay$1 extends Lambda implements Function0<Subscription> {
    ...
    RxPresenter$singleCallOrReplay$1(RxPresenter rxPresenter, Function2 function2, Function2 function22, Function0 function0, int i) {
    ...
    public final Subscription invoke() {
        Log.v(RxPresenter.TAG, "singleCallOrReplay: create new instance");
