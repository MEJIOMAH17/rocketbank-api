...
public final class ProfileFragment$uploadCover$1 extends Subscriber<UploadImageResponse> {
    final /* synthetic */ ProfileFragment this$0;

    public final void onCompleted() {
    }

    ProfileFragment$uploadCover$1(ProfileFragment profileFragment) {
    ...
    public final void onNext(UploadImageResponse uploadImageResponse) {
        if (uploadImageResponse != null) {
            ...
            if (uploadImageResponse != null) {
                ...
                patchProfileBody.getUser().setCoverId(String.valueOf(uploadImageResponse.getId()));
                this.this$0.userApi.patchProfile(patchProfileBody).observeOn(AndroidSchedulers.mainThread()).subscribe((Subscriber) new ProfileFragment$uploadCover$1$onNext$1(this));
                return;
            }
            this.this$0.hideProgressDialog();
