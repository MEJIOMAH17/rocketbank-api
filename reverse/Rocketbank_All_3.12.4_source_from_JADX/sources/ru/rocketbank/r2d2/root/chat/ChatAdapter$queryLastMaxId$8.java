...
final class ChatAdapter$queryLastMaxId$8 extends Lambda implements Function2<Long, TypingEvent, Long> {
    public static final ChatAdapter$queryLastMaxId$8 INSTANCE = new ChatAdapter$queryLastMaxId$8();

    ChatAdapter$queryLastMaxId$8() {
        super(2);
    }
