...
final class ChatState$update$2 extends Lambda implements Function3<Integer, List<? extends MessageIn>, MessageEvent, MessageEvent> {
    final /* synthetic */ ChatState this$0;

    ChatState$update$2(ChatState chatState) {
    ...
    public final MessageEvent invoke(int i, List<MessageIn> list, MessageEvent messageEvent) {
        ...
        return this.this$0.onTailUpdate(i, list, messageEvent);
    }
}
