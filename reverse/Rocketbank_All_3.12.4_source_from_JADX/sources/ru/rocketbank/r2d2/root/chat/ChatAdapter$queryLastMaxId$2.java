...
final class ChatAdapter$queryLastMaxId$2 extends Lambda implements Function2<Long, PendingMessagesEvent, Long> {
    public static final ChatAdapter$queryLastMaxId$2 INSTANCE = new ChatAdapter$queryLastMaxId$2();

    ChatAdapter$queryLastMaxId$2() {
        super(2);
    }
