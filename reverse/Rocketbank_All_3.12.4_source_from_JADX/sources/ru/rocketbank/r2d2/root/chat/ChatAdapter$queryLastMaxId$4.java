...
final class ChatAdapter$queryLastMaxId$4 extends Lambda implements Function2<Long, ProgressEvent, Long> {
    public static final ChatAdapter$queryLastMaxId$4 INSTANCE = new ChatAdapter$queryLastMaxId$4();

    ChatAdapter$queryLastMaxId$4() {
        super(2);
    }
