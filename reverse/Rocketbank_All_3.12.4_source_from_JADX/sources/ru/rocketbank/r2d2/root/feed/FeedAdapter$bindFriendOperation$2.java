...
public final class FeedAdapter$bindFriendOperation$2 implements OnActionListener {
    final /* synthetic */ FeedAdapter this$0;

    FeedAdapter$bindFriendOperation$2(FeedAdapter feedAdapter) {
        this.this$0 = feedAdapter;
    }

    public final void onAction(FeedItem feedItem) {
        Intrinsics.checkParameterIsNotNull(feedItem, "feedItem");
        this.this$0.feedPresenter.onRequestDeclined(feedItem);
    }
}
