...
public final class OperationViewHolder extends FeedViewHolder implements OnClickListener, OperationListener {
    ...
    public static final class Companion {
        ...
        public final int getSTATUS_NONE() {
            return OperationViewHolder.STATUS_NONE;
        }

        public final int getSTATUS_OUT() {
            return OperationViewHolder.STATUS_OUT;
        }

        public final int getSTATUS_IN() {
            return OperationViewHolder.STATUS_IN;
        }
    }
    ...
    public OperationViewHolder(View view) {
        ...
        findViewById = view.findViewById(C0859R.id.operationIconText);
        if (findViewById == null) {
            throw new TypeCastException("null cannot be cast to non-null type ru.rocketbank.core.widgets.RocketTextView");
        }
        this.operationIconText = (RocketTextView) findViewById;
        view = view.findViewById(C0859R.id.sputnik);
        Intrinsics.checkExpressionValueIsNotNull(view, "itemView.findViewById(R.id.sputnik)");
        this.sputnik = view;
    ...
    public final void setOperation(Operation operation, FeedItem feedItem) {
        ...
        this.sputnik.setVisibility(Intrinsics.areEqual(operation.getSputnik(), Boolean.TRUE) != null ? null : 8);
    }
