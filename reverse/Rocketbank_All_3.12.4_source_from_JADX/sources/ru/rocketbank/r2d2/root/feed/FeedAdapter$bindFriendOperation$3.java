...
public final class FeedAdapter$bindFriendOperation$3 implements OnActionListener {
    final /* synthetic */ FeedAdapter this$0;

    FeedAdapter$bindFriendOperation$3(FeedAdapter feedAdapter) {
        this.this$0 = feedAdapter;
    }

    public final void onAction(FeedItem feedItem) {
        Intrinsics.checkParameterIsNotNull(feedItem, "feedItem");
        this.this$0.feedPresenter.onRequestCancel(feedItem);
    }
}
