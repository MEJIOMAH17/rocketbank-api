...
final class CardDetailFragment$refreshAdapter$2 extends Lambda implements Function1<ParallaxItem, Unit> {
    final /* synthetic */ CardDetailFragment this$0;

    CardDetailFragment$refreshAdapter$2(CardDetailFragment cardDetailFragment) {
        this.this$0 = cardDetailFragment;
        super(1);
    }

    public final void invoke(ParallaxItem parallaxItem) {
        this.this$0.onTariffClick(CardDetailFragment.access$getToken$p(this.this$0));
    }
}
