...
final class CardPresenter$onAccount$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ ApCheckResult $androidPayResult;
    final /* synthetic */ CardPresenter this$0;

    CardPresenter$onAccount$1(CardPresenter cardPresenter, ApCheckResult apCheckResult) {
    ...
    public final void invoke() {
        ...
        if (access$getView$p != null) {
            ...
            access$getView$p.startManageAndroidPay(tur, this.$androidPayResult.isDefault());
        }
    }
}
