...
import ru.rocketbank.r2d2.activities.ReferencesActivity;
import ru.rocketbank.r2d2.widgets.recycler.parallax.vh.ParallaxItem;

/* compiled from: CardDetailFragment.kt */
final class CardDetailFragment$refreshAdapter$6 extends Lambda implements Function1<ParallaxItem, Unit> {
    final /* synthetic */ CardDetailFragment this$0;

    CardDetailFragment$refreshAdapter$6(CardDetailFragment cardDetailFragment) {
        this.this$0 = cardDetailFragment;
        super(1);
    }

    public final void invoke(ParallaxItem parallaxItem) {
        parallaxItem = ReferencesActivity.Companion;
