...
public class RefillRequestActivity extends SecuredActivity {
    public static void start(FriendTransfersResponseUrls friendTransfersResponseUrls, FriendTransfersRequestData friendTransfersRequestData, Context context) {
        Intent intent = new Intent(context, RefillRequestActivity.class);
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(C0859R.layout.activity_refill_request);
        Toolbar toolbar = (Toolbar) findViewById(C0859R.id.toolbar);
        if (toolbar != null) {
            toolbar.setTitle(C0859R.string.refill_title);
        ...
        Fragment refillRequestUrlsFragment = new RefillRequestUrlsFragment();
        refillRequestUrlsFragment.setArguments(bundle);
        getSupportFragmentManager().beginTransaction().replace(C0859R.id.content, refillRequestUrlsFragment).commit();
    }
}
