...
public final class DownloadActivity$loadReference$$inlined$let$lambda$2 extends Subscriber<String> {
    final /* synthetic */ DownloadActivity this$0;

    public final void onCompleted() {
    }

    DownloadActivity$loadReference$$inlined$let$lambda$2(DownloadActivity downloadActivity) {
    ...
    public final void onError(Throwable th) {
        ...
        downloadActivity.errorText = string;
