...
final class TransferActivity$sendMoney$3 extends FunctionReference implements Function2<TransferActivity, RefillCardResponse, Unit> {
    public static final TransferActivity$sendMoney$3 INSTANCE = new TransferActivity$sendMoney$3();

    TransferActivity$sendMoney$3() {
        super(2);
    }
