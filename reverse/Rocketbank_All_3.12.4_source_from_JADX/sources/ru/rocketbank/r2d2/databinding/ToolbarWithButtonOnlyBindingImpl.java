...
public class ToolbarWithButtonOnlyBindingImpl extends ToolbarWithButtonOnlyBinding {
    ...
    public ToolbarWithButtonOnlyBindingImpl(DataBindingComponent dataBindingComponent, View view) {
        this(dataBindingComponent, view, mapBindings(dataBindingComponent, view, 3, sIncludes, sViewsWithIds));
    }

    private ToolbarWithButtonOnlyBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
    ...
    protected void executeBindings() {
        ...
        ToolbarWithButtonOnlyBindingImpl toolbarWithButtonOnlyBindingImpl = this;
        synchronized (this) {
            try {
                j = toolbarWithButtonOnlyBindingImpl.mDirtyFlags;
                long j2 = 0;
                toolbarWithButtonOnlyBindingImpl.mDirtyFlags = 0;
            } finally {
                j = 
/*
Method generation error in method: ru.rocketbank.r2d2.databinding.ToolbarWithButtonOnlyBindingImpl.executeBindings():void, dex: classes2.dex
jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x008e: MERGE  (r2_5 'j' long) = (r0_1 android.view.View$OnClickListener), (r14_6 android.view.View$OnClickListener) in method: ru.rocketbank.r2d2.databinding.ToolbarWithButtonOnlyBindingImpl.executeBindings():void, dex: classes2.dex
