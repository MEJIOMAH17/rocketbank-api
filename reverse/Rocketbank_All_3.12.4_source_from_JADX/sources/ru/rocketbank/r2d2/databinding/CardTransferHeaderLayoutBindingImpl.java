...
public class CardTransferHeaderLayoutBindingImpl extends CardTransferHeaderLayoutBinding {
    ...
    public CardTransferHeaderLayoutBindingImpl(DataBindingComponent dataBindingComponent, View view) {
        this(dataBindingComponent, view, mapBindings(dataBindingComponent, view, 5, sIncludes, sViewsWithIds));
    }

    private CardTransferHeaderLayoutBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
    ...
    protected void executeBindings() {
        ...
        CardTransferHeaderLayoutBindingImpl cardTransferHeaderLayoutBindingImpl = this;
        synchronized (this) {
            try {
                j = cardTransferHeaderLayoutBindingImpl.mDirtyFlags;
                long j2 = 0;
                cardTransferHeaderLayoutBindingImpl.mDirtyFlags = 0;
            } finally {
                j = r0;
            }
        }
        CardAbilityHandler cardAbilityHandler = cardTransferHeaderLayoutBindingImpl.mActions;
        CardAbilityData cardAbilityData = cardTransferHeaderLayoutBindingImpl.mAbility;
        long j3 = j & 40;
        if (j3 == 0 || cardAbilityHandler == null) {
            onClickListener = null;
        } else {
            OnClickListenerImpl onClickListenerImpl;
            if (cardTransferHeaderLayoutBindingImpl.mActionsOnPressedPhotoAndroidViewViewOnClickListener == null) {
                onClickListenerImpl = new OnClickListenerImpl();
                cardTransferHeaderLayoutBindingImpl.mActionsOnPressedPhotoAndroidViewViewOnClickListener = onClickListenerImpl;
            } else {
                onClickListenerImpl = cardTransferHeaderLayoutBindingImpl.mActionsOnPressedPhotoAndroidViewViewOnClickListener;
            }
                        ...
                        if (obj != null) {
                            ...
                            if ((j & j4) != j2) {
                                ...
                                if (nfcVisible != null) {
                                    ...
                                    j5 = 50;
                                    if ((j & j5) != j2) {
                                        cardTransferHeaderLayoutBindingImpl.cardPhoto.setVisibility(i2);
                                    }
                                    if (j3 != j2) {
                                        cardTransferHeaderLayoutBindingImpl.cardPhoto.setOnClickListener(onClickListener);
                                    }
                                    if ((j & j6) != j2) {
                                        cardTransferHeaderLayoutBindingImpl.mboundView2.setVisibility(i);
                                    }
                                    if ((j & j4) != j2) {
                                        cardTransferHeaderLayoutBindingImpl.rocketTextView.setVisibility(i3);
                                    }
                                }
                            }
                            i3 = 0;
