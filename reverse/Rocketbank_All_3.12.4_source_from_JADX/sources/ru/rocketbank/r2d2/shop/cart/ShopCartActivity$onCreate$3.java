...
final class ShopCartActivity$onCreate$3 extends Lambda implements Function1<CartItem, Unit> {
    final /* synthetic */ ShopCartActivity this$0;

    ShopCartActivity$onCreate$3(ShopCartActivity shopCartActivity) {
    ...
    public final void invoke(CartItem cartItem) {
        ...
        ((ShopCartPresenter) this.this$0.getPresenter()).remove(cartItem);
    }
}
