...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C06471();
    ...
    static class C06471 implements Comparator<Comparable> {
        C06471() {
        }
    ...
    class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C12361 extends LinkedTreeMapIterator<Entry<K, V>> {
            C12361() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C12371 extends LinkedTreeMapIterator<K> {
            C12371() {
                super();
            }
