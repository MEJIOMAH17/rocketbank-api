...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C06461();
    ...
    static class C06461 implements Comparator<Comparable> {
        C06461() {
        }
    ...
    static class AvlIterator<K, V> {
        ...
        final void reset(Node<K, V> node) {
            Node<K, V> node2 = null;
            while (true) {
    ...
    final class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C12341 extends LinkedTreeMapIterator<Entry<K, V>> {
            C12341() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C12351 extends LinkedTreeMapIterator<K> {
            C12351() {
                super();
            }
