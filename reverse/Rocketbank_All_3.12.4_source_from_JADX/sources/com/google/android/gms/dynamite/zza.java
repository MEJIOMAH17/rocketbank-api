            ...
            if (i != 1598968902) {
                switch (i) {
                    case 1:
                        ...
                        i = zze(com.google.android.gms.dynamic.IObjectWrapper.zza.zzcd(parcel.readStrongBinder()), parcel.readString());
                    ...
                    case 3:
                        parcel.enforceInterface("com.google.android.gms.dynamite.IDynamiteLoader");
                        i = zza(com.google.android.gms.dynamic.IObjectWrapper.zza.zzcd(parcel.readStrongBinder()), parcel.readString(), parcel.readInt() != 0);
                        parcel2.writeNoException();
                        parcel2.writeInt(i);
                        return true;
                    default:
