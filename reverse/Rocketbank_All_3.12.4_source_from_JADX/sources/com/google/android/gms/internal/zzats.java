...
public final class zzats {
    ...
    public static zza<Long> zzbsm = zza.zzj("measurement.alarm_manager.minimum_interval", 60000);
    ...
    public static zza<Long> zzbsv = zza.zzj("measurement.service_client.idle_disconnect_millis", 5000);
