...
public interface zzaqp extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzaqp {
        ...
        private static class zza implements zzaqp {
        ...
        public static zzaqp zzcX(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzaqp)) ? new zza(iBinder) : (zzaqp) queryLocalInterface;
        }
