...
public class zzabx<R extends Result> extends TransformedResult<R> implements ResultCallback<R> {
    ...
    private final class zza extends Handler {
        ...
        public zza(zzabx zzabx, Looper looper) {
            this.zzaDt = zzabx;
            super(looper);
        }
                ...
                zzabo.zzwv().submit(new Runnable(this) {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            zzaaf.zzaAg.set(Boolean.FALSE);
                            this.zzaDt.zzd(r);
                            GoogleApiClient googleApiClient2 = (GoogleApiClient) this.zzaDt.zzaAj.get();
                            if (googleApiClient2 != null) {
                                googleApiClient2.zzb(this.zzaDt);
                            }
                            throw th;
                        }
                    }
