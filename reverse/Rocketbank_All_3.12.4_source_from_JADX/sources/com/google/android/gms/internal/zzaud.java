...
public class zzaud extends zzauh {
    ...
    private final class zzb implements UncaughtExceptionHandler {
        ...
        public zzb(zzaud zzaud, String str) {
            this.zzbtW = zzaud;
            zzac.zzw(str);
            this.zzbtV = str;
        }
    ...
    private final class zzc<V> extends FutureTask<V> implements Comparable<zzc> {
        ...
        zzc(zzaud zzaud, Runnable runnable, boolean z, String str) {
            this.zzbtW = zzaud;
            super(runnable, null);
            zzac.zzw(str);
            this.zzbtV = str;
            ...
            if (this.zzbtX == Long.MAX_VALUE) {
                zzaud.zzKl().zzLZ().log("Tasks index overflow");
            }
        }

        zzc(zzaud zzaud, Callable<V> callable, boolean z, String str) {
            this.zzbtW = zzaud;
            super(callable);
            zzac.zzw(str);
            this.zzbtV = str;
        ...
        public final int zzb(zzc zzc) {
            if (this.zzbtY != zzc.zzbtY) {
                return this.zzbtY ? -1 : 1;
            } else {
                if (this.zzbtX < zzc.zzbtX) {
                    return -1;
                }
                if (this.zzbtX > zzc.zzbtX) {
                    return 1;
    ...
    private final class zzd extends Thread {
        ...
        public zzd(zzaud zzaud, String str, BlockingQueue<FutureTask<?>> blockingQueue) {
            this.zzbtW = zzaud;
            zzac.zzw(str);
    ...
    public <V> Future<V> zzd(Callable<V> callable) throws IllegalStateException {
        zzob();
        zzac.zzw(callable);
        zzc zzc = new zzc(this, (Callable) callable, false, "Task exception on worker thread");
    ...
    public <V> Future<V> zze(Callable<V> callable) throws IllegalStateException {
        zzob();
        zzac.zzw(callable);
        zzc zzc = new zzc(this, (Callable) callable, true, "Task exception on worker thread");
        if (Thread.currentThread() == this.zzbtL) {
            zzc.run();
            return zzc;
        }
