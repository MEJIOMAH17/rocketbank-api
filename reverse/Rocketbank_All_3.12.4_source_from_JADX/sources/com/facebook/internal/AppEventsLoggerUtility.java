...
public class AppEventsLoggerUtility {
    private static final Map<GraphAPIActivityType, String> API_ACTIVITY_TYPE_TO_STRING = new C03871();

    /* renamed from: com.facebook.internal.AppEventsLoggerUtility$1 */
    static class C03871 extends HashMap<GraphAPIActivityType, String> {
        C03871() {
