...
public class SecondaryDrawerItem extends BaseSecondaryDrawerItem<SecondaryDrawerItem> {
    ...
    public int getLayoutRes() {
        return C0859R.layout.material_drawer_item_secondary;
    }
    ...
    public SecondaryDrawerItem withBadge(StringHolder stringHolder) {
        this.mBadge = stringHolder;
        return this;
    }

    public SecondaryDrawerItem withBadge(String str) {
        this.mBadge = new StringHolder(str);
        return this;
    }

    public SecondaryDrawerItem withBadge(int i) {
